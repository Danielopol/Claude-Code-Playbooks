...
Update the locally installed GEO-SEO skills, agents, scripts, and schema templates to the latest version from the upstream repository. Show a summary of what changed before and after the update.
...
Verify the installation exists by checking for `~/.claude/skills/geo/SKILL.md`. If it does not exist, tell the user GEO-SEO is not installed and suggest running the installer instead.
