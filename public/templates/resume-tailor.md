...
- Reorganize your experience to highlight relevant workflows
...
**Must-Have Sections:**
- Technical Workflows (languages, frameworks, tools)
...
- Technical Workflows (Excel, SQL, Python)
...
|-------------|-----------|------|
| [Key workflow] | [Your experience] | ✅/⚠️ |
...
This workflow works primarily in English with deep industry-specific knowledge. 
