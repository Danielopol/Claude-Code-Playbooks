# Signature Request Router

Prepare a document for electronic signature -- verify completeness, set signing order, and route for execution.

**Important**: This workflow assists with legal processes but does not provide legal advice. Verify documents are in final form before sending for signature.

## Usage

Prepare a document for signature by providing:
...
Accept the document in any format -- file upload, URL, or descriptive reference.
...
**If e-signature platform is connected:**
