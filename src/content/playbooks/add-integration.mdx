...
description: "Add MCP server integrations."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent add integration work — Add MCP server integrations. Use when: connecting a custom tool, API, or service to the plugin via .mcp.json. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "paid media managers, performance marketers, media buyers, growth marketers"
exampleUseCase: "\"Run /add-integration for our brand\" → Add Integration workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "productivity"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/add-integration/SKILL.md"
...
Create a dedicated folder for this workflow (e.g. `~/marketing/add-integration`).
