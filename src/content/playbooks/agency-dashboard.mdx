...
description: "Portfolio-level client overview."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent agency dashboard work — Portfolio-level client overview. Use when: cross-brand campaign status, budget pacing, KPI health, team utilization. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "agency owners, account managers, consultants"
exampleUseCase: "\"Run /agency-dashboard for our brand\" → Agency Dashboard workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "data-reporting"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/agency-dashboard/SKILL.md"
