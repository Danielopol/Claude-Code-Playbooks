...
seoHook: "Every year you set goals, and every December you realize you drifted. You never paused to honestly assess where you are, so your resolutions were based on vibes instead of reality."
targetAudience: "professionals doing year-end reflection, life coaches guiding clients through transitions, anyone feeling stuck and wanting clarity, goal-setters who never follow through, people approaching milestone birthdays"
exampleUseCase: "\"Help me audit where I am across all life areas\" → Honest assessment across career, health, finances, relationships, and growth with pattern analysis, then quarterly milestones and monthly actions you can start this week"
