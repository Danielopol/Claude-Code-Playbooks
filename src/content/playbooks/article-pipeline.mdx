...
seoHook: "You have a notes app full of blog ideas that never become articles. Some are half-baked, some overlap, and you never know which one to start writing because there's no system to evaluate, outline, and draft them."
targetAudience: "bloggers and content creators with idea backlogs, freelance writers managing multiple publications, founders doing thought leadership, developer advocates writing technical content, newsletter authors"
exampleUseCase: "\"I have 15 blog ideas — help me pick the best one and write it\" → Ideas scored by audience fit and SEO potential, winner gets a detailed outline with keyword strategy, then a polished 1,500-word first draft saved as a file ready to edit"
