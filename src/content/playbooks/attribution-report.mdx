...
description: "Run multi-touch attribution analysis."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent attribution report work — Run multi-touch attribution analysis. Use when: first/last-touch, linear, time-decay, position-based revenue allocation. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "marketing analysts, growth analysts, BI leads"
exampleUseCase: "\"Run /attribution-report for our brand\" → Attribution Report workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/attribution-report/SKILL.md"
...
Create a dedicated folder for this workflow (e.g. `~/marketing/attribution-report`).
