...
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent audience profile work — Build detailed buyer personas. Use when: demographics, psychographics, behaviors, JTBD, content preferences. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /audience-profile for our brand\" → Audience Profile workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/audience-profile/SKILL.md"
tags: ["audience", "profile"]
