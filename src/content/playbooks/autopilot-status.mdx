...
description: "Check campaign autopilot status."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent autopilot status work — Check campaign autopilot status. Use when: health scores, auto-corrections, guardrail review, campaigns needing attention. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /autopilot-status for our brand\" → Autopilot Status workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "productivity"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/autopilot-status/SKILL.md"
...
Create a dedicated folder for this workflow (e.g. `~/marketing/autopilot-status`).
