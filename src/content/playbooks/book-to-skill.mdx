---
title: "Book-to-Skill: Turn Any Book or PDF Into a Claude Skill"
description: "The book-to-skill Claude skill (virgiliojr94/book-to-skill on GitHub): convert any technical PDF or EPUB into a structured Claude Code skill — extracting named frameworks, principles, techniques, and anti-patterns into a reusable knowledge base with on-demand chapter files."
