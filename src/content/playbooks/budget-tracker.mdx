...
description: "Track budget pacing in real time."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent budget tracker work — Track budget pacing in real time. Use when: cross-platform spend tracking, overspend alerts, reallocation recommendations. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "paid media managers, performance marketers, media buyers, growth marketers"
exampleUseCase: "\"Run /budget-tracker for our brand\" → Budget Tracker workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/budget-tracker/SKILL.md"
tags: ["budget", "tracker"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/budget-tracker`).
