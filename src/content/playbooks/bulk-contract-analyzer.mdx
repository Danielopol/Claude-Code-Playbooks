...
seoHook: "Your M&A deal has 200 contracts to review and the due diligence deadline is in two weeks. Reading each one takes an hour, and missing a single unfavorable clause could cost millions after close."
targetAudience: "M&A lawyers doing due diligence, corporate counsel reviewing vendor contracts, paralegals supporting portfolio reviews, compliance officers auditing agreements, startup founders reviewing investor term sheets"
exampleUseCase: "\"Review these 150 vendor contracts and flag risks\" → Key provisions extracted (termination, liability, IP, auto-renewal), risk scores assigned, a searchable database of all clauses, and a summary of the 12 highest-risk agreements"
