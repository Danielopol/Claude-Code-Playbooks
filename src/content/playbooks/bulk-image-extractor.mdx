...
seoHook: "You need the images from a 200-page PDF or a Google Doc full of screenshots, but copy-paste gives you low-res blobs and there's no 'export all images' button anywhere."
targetAudience: "designers extracting assets from client documents, marketers pulling images from reports, teachers collecting visuals from course materials, researchers saving figures from papers, content creators repurposing visual assets"
exampleUseCase: "\"Extract all images from this 150-page PDF and these 3 Google Docs\" → All embedded images saved as high-resolution files in an organized folder, named by source document and page number"
