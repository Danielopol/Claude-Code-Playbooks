...
description: "Check active campaign status."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent campaign status work — Check active campaign status. Use when: cross-platform execution history, performance metrics, pending approvals. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /campaign-status for our brand\" → Campaign Status workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/campaign-status/SKILL.md"
...
Create a dedicated folder for this workflow (e.g. `~/marketing/campaign-status`).
