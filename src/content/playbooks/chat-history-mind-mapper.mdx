---
title: "Chat History Mind Mapper — Visualize AI Conversations"
description: "Export Claude or ChatGPT chat history, chunk it into summaries, and generate a visual mind map of topics and insights. Perfect for importing into NotebookLM or Obsidian."
seoHook: "You've had 500 AI conversations full of great ideas, solutions, and insights — but they're buried in chat history you'll never scroll through again. All that accumulated knowledge is effectively lost."
targetAudience: "power users of ChatGPT or Claude with extensive chat history, researchers using AI as a thinking partner, knowledge workers who want to review past conversations, Obsidian users building a second brain, NotebookLM users"
exampleUseCase: "\"Map my last 6 months of Claude conversations\" → Chat history chunked, summarized, and organized into a visual mind map showing topic clusters, key insights, and recurring themes — ready to import into NotebookLM or Obsidian"
