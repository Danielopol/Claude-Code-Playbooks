...
description: "Plan client onboarding."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent client onboarding work — Plan client onboarding. Use when: kickoff agenda, discovery questionnaire, account setup checklist, 30-60-90 day plan. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "agency owners, account managers, consultants"
exampleUseCase: "\"Run /client-onboarding for our brand\" → Client Onboarding workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "sales-revenue"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/client-onboarding/SKILL.md"
...
Create a dedicated folder for this workflow (e.g. `~/marketing/client-onboarding`).
