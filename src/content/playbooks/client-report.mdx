---
title: "Client Report"
description: "Generate client-facing reports."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent client report work — Generate client-facing reports. Use when: white-labeled performance report with KPIs, trends, strategic recommendations. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "agency owners, account managers, consultants"
exampleUseCase: "\"Run /client-report for our brand\" → Client Report workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "data-reporting"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/client-report/SKILL.md"
tags: ["client", "report"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/client-report`).
