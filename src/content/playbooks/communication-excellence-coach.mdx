...
seoHook: "That email you sent too quickly, the feedback conversation you avoided, the presentation that lost the room — most career setbacks aren't about technical ability. They're about communication nobody formally taught you."
targetAudience: "professionals preparing for difficult conversations, managers giving performance feedback, employees writing sensitive emails, presenters wanting to improve delivery, anyone navigating workplace politics through written communication"
exampleUseCase: "\"Review this email to my VP about pushing back on the deadline\" → Tone analysis, three rewrite options from diplomatic to direct, roleplay of their likely responses, and a recommended approach with rationale"
