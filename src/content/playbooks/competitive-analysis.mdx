...
seoHook: "You know who your competitors are but you've never done a proper analysis. When someone asks 'how do we compare to X?' you wing it based on memory from six months ago instead of data."
targetAudience: "product managers positioning against competitors, startup founders writing pitch decks, marketing teams differentiating their messaging, sales teams needing competitive talking points, strategy consultants advising clients"
exampleUseCase: "\"Analyze our top 5 competitors in the project management space\" → Side-by-side comparison of features, pricing, positioning, and go-to-market strategies with gap analysis and differentiation opportunities"
