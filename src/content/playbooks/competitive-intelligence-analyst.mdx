...
seoHook: "Your competitive knowledge lives in people's heads — the VP knows pricing from a deal six months ago, the PM saw a feature launch on Twitter, but nobody has the full picture in one place. When a deal is on the line, you scramble."
targetAudience: "sales enablement teams building battlecards, product marketing managers tracking feature parity, VP of Strategy needing competitive dashboards, revenue teams losing deals to competitors, growth-stage companies formalizing competitive ops"
exampleUseCase: "\"Build a competitive intelligence system for our top 3 competitors\" → Positioning matrices, sales battlecards with objection handling, feature parity tracker, pricing intelligence database, win/loss analysis framework, and monitoring triggers for competitor moves"
