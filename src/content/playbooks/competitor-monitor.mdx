...
description: "Set up ongoing competitor monitoring."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent competitor monitor work — Set up ongoing competitor monitoring. Use when: defining tracked competitors, scan frequency, change detection alerts. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "competitive intelligence analysts, strategists, marketing leaders"
exampleUseCase: "\"Run /competitor-monitor for our brand\" → Competitor Monitor workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "data-reporting"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/competitor-monitor/SKILL.md"
...
Create a dedicated folder for this workflow (e.g. `~/marketing/competitor-monitor`).
