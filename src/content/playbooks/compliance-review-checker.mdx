...
seoHook: "You're about to launch a new feature that collects user data, and your legal team is a 3-week backlog. You need to know now — does this violate GDPR? Do we need consent? What about CCPA?"
targetAudience: "product teams launching features with data implications, startup founders without in-house legal, compliance officers triaging regulatory reviews, DPOs managing privacy impact assessments, engineering leads implementing data collection"
exampleUseCase: "\"Review our new analytics feature for GDPR and CCPA compliance\" → Applicable regulations identified, consent requirements mapped, DPA checklist completed, data subject request handling guidance, and a prioritized list of required changes before launch"
