---
title: "Composio SDK with Claude Code: Connect 250+ APIs in Minutes"
description: "Connect Claude Code to 250+ APIs using Composio SDK. Build AI agents that send emails, create GitHub issues, and post to Slack — not just generate text."
