---
title: "Connect"
description: "Set up an MCP connector."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent connect work — Set up an MCP connector. Use when: connecting Google Ads, Salesforce, Mailchimp, or any service to the plugin. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /connect for our brand\" → Connect workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "productivity"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/connect/SKILL.md"
tags: ["connect"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/connect`).
