---
title: "Content Decay Scan"
description: "Scan for content decay."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent content decay scan work — Scan for content decay. Use when: declining traffic, falling rankings, outdated stats, dropping AI citations, refresh priority. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "content marketers, content strategists, editors"
exampleUseCase: "\"Run /content-decay-scan for our brand\" → Content Decay Scan workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/content-decay-scan/SKILL.md"
tags: ["content", "decay", "scan"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/content-decay-scan`).
