...
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent content repurpose work — Repurpose content across channels. Use when: blog-to-social, webinar-to-article, pillar derivatives, format adaptation. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "content marketers, content strategists, editors"
exampleUseCase: "\"Run /content-repurpose for our brand\" → Content Repurpose workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/content-repurpose/SKILL.md"
