...
description: "Build counter-narrative playbooks."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent counter narrative work — Build counter-narrative playbooks. Use when: competitor rebrand, new category claim, aggressive campaign, price change response. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /counter-narrative for our brand\" → Counter Narrative workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/counter-narrative/SKILL.md"
tags: ["counter", "narrative"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/counter-narrative`).
