...
seoHook: "Cover letters are the worst part of job hunting — you know they matter, but staring at a blank page trying to sound enthusiastic about a company you researched for 5 minutes feels impossible."
targetAudience: "active job seekers who hate writing cover letters, career coaches helping clients with applications, recruiters advising candidates on applications, professionals applying for stretch roles, anyone who procrastinates on applications because of the cover letter"
exampleUseCase: "\"Write a cover letter for this Senior Designer role at Figma using my resume\" → Tailored letter matching your experience to their needs, weaving in why Figma specifically (not just 'I love design tools'), with a confident but not arrogant tone"
