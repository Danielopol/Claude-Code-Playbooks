...
description: "Assess ad creative fatigue."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent creative health work — Assess ad creative fatigue. Use when: ads underperform, need refresh timing, or creative lifecycle review. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /creative-health for our brand\" → Creative Health workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/creative-health/SKILL.md"
...
Create a dedicated folder for this workflow (e.g. `~/marketing/creative-health`).
