...
description: "Design structured ad creative tests."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent creative testing framework work — Design structured ad creative tests. Use when: planning A/B tests, multivariate creative strategy, or iteration. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /creative-testing-framework for our brand\" → Creative Testing Framework workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/creative-testing-framework/SKILL.md"
tags: ["creative", "testing", "framework"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/creative-testing-framework`).
