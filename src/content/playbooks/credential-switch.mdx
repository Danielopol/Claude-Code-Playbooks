---
title: "Credential Switch"
description: "Switch brand credentials."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent credential switch work — Switch brand credentials. Use when: activating the correct API keys for MCP servers in multi-client workflows. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /credential-switch for our brand\" → Credential Switch workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "productivity"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/credential-switch/SKILL.md"
tags: ["credential", "switch"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/credential-switch`).
