...
seoHook: "Claude writes decent drafts but they still sound like Claude, not you. You spend 15-30 minutes on every piece cutting 'furthermore,' fixing the tone, and removing AI slop. That editing time adds up to hours every week."
targetAudience: "writers who use AI but edit heavily for voice, content creators maintaining a personal brand voice, newsletter authors who need output that sounds like them, marketers producing high-volume content, anyone tired of AI writing that reads like AI writing"
exampleUseCase: "\"Run the critic on this blog draft\" → Internal critic reviews against your voice file, flags 8 specific issues ('intro reads like LinkedIn, not like you'), Claude rewrites in 3 rounds until it passes — zero manual editing needed"
