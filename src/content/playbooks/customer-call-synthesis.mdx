...
seoHook: "You did 20 customer calls this month and the insights are trapped in individual transcripts nobody has time to re-read. The patterns are there — you just can't synthesize 15 hours of conversation into decisions."
targetAudience: "product managers running discovery interviews, UX researchers synthesizing user feedback, founders validating product ideas, customer success teams tracking sentiment trends, sales teams analyzing objection patterns"
exampleUseCase: "\"Synthesize these 20 customer call transcripts\" → Cross-call pattern analysis, top 5 validated assumptions, 3 invalidated hypotheses, recurring feature requests ranked by frequency, and a one-page research summary ready for your product review"
