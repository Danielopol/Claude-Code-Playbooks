...
seoHook: "Your analysis code is a mess of Jupyter notebooks with no structure, inconsistent variable names, and visualizations that need complete rework before you can put them in a paper or presentation."
targetAudience: "graduate students analyzing dissertation data, researchers producing publication-ready figures, data scientists building reproducible analysis workflows, postdocs preparing results for papers, lab managers standardizing analysis practices"
exampleUseCase: "\"Analyze this survey dataset from exploration to publication\" → Structured pipeline: data cleaning, exploratory analysis, regression models, publication-quality visualizations, and a results summary — reproducible and ready for your paper"
