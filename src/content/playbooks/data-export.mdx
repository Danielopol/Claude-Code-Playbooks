---
title: "Data Export"
description: "Export marketing data."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent data export work — Export marketing data. Use when: sending data to BigQuery, Google Sheets, or Supabase for analysis or reporting. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /data-export for our brand\" → Data Export workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "productivity"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/data-export/SKILL.md"
tags: ["data", "export"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/data-export`).
