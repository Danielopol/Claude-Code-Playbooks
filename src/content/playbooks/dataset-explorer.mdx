...
seoHook: "Someone hands you a CSV with 50 columns and no documentation. Before you can analyze anything, you need to understand what you're looking at — column types, missing values, distributions, outliers. That first-look step takes longer than the analysis."
targetAudience: "data analysts receiving new datasets, data scientists starting exploratory analysis, BI teams onboarding new data sources, researchers working with unfamiliar datasets, anyone who opens a CSV and thinks 'where do I even start?'"
exampleUseCase: "\"Profile this 500K-row customer dataset\" → Column classification, distribution summaries, missing value map, outlier detection, relationship discovery between fields, data quality flags, and recommended follow-up analyses"
