...
seoHook: "You've been going back and forth on this decision for weeks. Every time you think you've decided, a new consideration pops up and you're back to square one. Your brain isn't built to weigh 7 criteria across 4 options simultaneously."
targetAudience: "professionals making career decisions, teams choosing between vendors or tools, founders deciding on strategic direction, couples making major life decisions, anyone stuck in analysis paralysis on an important choice"
exampleUseCase: "\"Help me decide between 4 job offers\" → Criteria defined (salary, growth, culture, location, role fit), importance weights assigned, each option scored, weighted totals calculated, and a devil's advocate challenge of the winner — saved as a file for future reference"
