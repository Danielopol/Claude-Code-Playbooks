...
seoHook: "You paid $99 for a 23andMe test and got a raw data file with 700,000 genetic markers you can't read. The health reports cost extra, and third-party tools feel sketchy. Your genome is sitting in a zip file doing nothing."
targetAudience: "23andMe and AncestryDNA users wanting more from their data, biohackers exploring genetic health markers, health-conscious individuals preparing for doctor visits, people with family history of genetic conditions, quantified-self enthusiasts"
exampleUseCase: "\"Analyze my 23andMe raw data for health-related variants\" → Report identifying key SNPs for MTHFR, APOE, BRCA, and caffeine metabolism — with risk context, what each variant means, and specific questions to bring to your doctor"
