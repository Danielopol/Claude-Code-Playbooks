...
seoHook: "Generic code reviewers catch generic issues. But your field has its own standards — medical device software needs different scrutiny than financial models, and legal documents need different checks than academic papers. Off-the-shelf review tools miss what matters most in your domain."
targetAudience: "domain experts building review processes for their field, quality assurance leads in regulated industries, research group leaders standardizing paper reviews, engineering managers creating architecture review checklists, anyone reviewing specialized work without a structured framework"
exampleUseCase: "\"Build a reviewer for healthcare data pipelines\" → Custom 5-lens reviewer checking HIPAA terminology compliance, statistical methodology validity, precedent against published guidelines, known limitations of the approach, and downstream patient impact — tailored to your exact domain"
