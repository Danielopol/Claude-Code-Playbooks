...
seoHook: "You have the expertise to teach a course but staring at a blank curriculum outline is paralyzing. Planning modules, writing lessons, creating assessments, and making it all flow — that's instructional design, and it's a whole separate skill from knowing your subject."
targetAudience: "subject matter experts creating their first online course, corporate trainers building employee training programs, educators moving content to LMS platforms, course creators on Teachable or Thinkific, consultants packaging expertise into courses"
exampleUseCase: "\"Create a 6-module Python course for data analysts\" → Full curriculum with learning objectives, 24 lessons with explanations and code exercises, quizzes per module, a capstone project, and everything formatted for Teachable import"
category: "education"
