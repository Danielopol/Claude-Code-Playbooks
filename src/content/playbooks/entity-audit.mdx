---
title: "Entity Audit"
description: "Audit brand entity consistency."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent entity audit work — Audit brand entity consistency. Use when: checking Wikidata, Knowledge Panel, or directory discrepancies. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /entity-audit for our brand\" → Entity Audit workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/entity-audit/SKILL.md"
tags: ["entity", "audit"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/entity-audit`).
