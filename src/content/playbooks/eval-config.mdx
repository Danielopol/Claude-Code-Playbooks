---
title: "Eval Config"
description: "Configure content eval settings."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent eval config work — Configure content eval settings. Use when: adjusting score thresholds, dimension weights, or auto-reject rules. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /eval-config for our brand\" → Eval Config workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "data-reporting"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/eval-config/SKILL.md"
tags: ["eval", "config"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/eval-config`).
