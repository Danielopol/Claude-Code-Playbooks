...
description: "Design executive marketing dashboards."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent executive dashboard work — Design executive marketing dashboards. Use when: building CMO reports, board metrics, or leadership views. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "marketing analysts, growth analysts, BI leads"
exampleUseCase: "\"Run /executive-dashboard for our brand\" → Executive Dashboard workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "data-reporting"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/executive-dashboard/SKILL.md"
...
Create a dedicated folder for this workflow (e.g. `~/marketing/executive-dashboard`).
