---
title: "Focus Group"
description: "Run synthetic focus groups."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent focus group work — Run synthetic focus groups. Use when: testing messaging, pricing, or positioning before live research spend. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /focus-group for our brand\" → Focus Group workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/focus-group/SKILL.md"
tags: ["focus", "group"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/focus-group`).
