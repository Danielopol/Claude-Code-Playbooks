---
title: "Geo Monitor"
description: "Monitor brand AI visibility."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent geo monitor work — Monitor brand AI visibility. Use when: tracking mentions in ChatGPT, Perplexity, Gemini, or AI Overviews. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /geo-monitor for our brand\" → Geo Monitor workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/geo-monitor/SKILL.md"
tags: ["geo", "monitor"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/geo-monitor`).
