---
title: "Hegelian Dialectic — The Electric Monks"
description: "Two AI subagents fully commit to opposing positions while you orchestrate structural contradiction analysis and synthesis. Stress-test ideas, resolve tensions, and build deeper mental models across any domain."
seoHook: "You're stuck in a binary debate — build vs. buy, centralize vs. decentralize, move fast vs. be careful. But the real answer isn't either side; it's a synthesis neither side can see because they're too busy defending their position."
targetAudience: "strategy leaders wrestling with complex either/or decisions, executives evaluating opposing recommendations from their team, consultants who need to present balanced analysis, researchers exploring multi-perspective problems, anyone stuck in a false dichotomy"
exampleUseCase: "\"Analyze: Should we build our own ML infrastructure or use cloud services?\" → Two AI agents argue opposing positions with full conviction, then a synthesis reveals the hybrid approach neither side considered — with specific conditions for when to build vs. buy and a phased migration strategy"
category: "executive-strategy"
difficulty: "advanced"
timeToSetup: "15 minutes"
author: "Kyle A. Mathews"
sourceUrl: "https://github.com/KyleAMathews/hegelian-dialectic-skill"
tags: ["dialectic", "reasoning", "multi-agent", "strategy", "decision-making", "synthesis", "critical-thinking", "debate"]
createdAt: "2026-03-05"
---

## What This Does

Spawns two committed AI subagents — the "Electric Monks" — to fully inhabit opposing viewpoints on a complex problem. A third orchestrator agent then decomposes both arguments, identifies cross-domain connections, and synthesizes a higher-order perspective that transcends the original dichotomy. You operate from a neutral analytical position, free to interrupt and correct throughout.

Based on [Kyle A. Mathews's Hegelian Dialectic Skill](https://github.com/KyleAMathews/hegelian-dialectic-skill).

## Prerequisites

- Claude Code installed (or another coding agent supporting subagent spawning)
- Best-available model for maximum reasoning capability
- 10-15 minutes per round; 3+ rounds recommended for depth
You (Orchestrator)
