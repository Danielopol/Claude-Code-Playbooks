...
description: "Audit hreflang tags."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent hreflang check work — Audit hreflang tags. Use when: checking missing tags, incorrect language codes, or x-default configuration. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /hreflang-check for our brand\" → Hreflang Check workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/hreflang-check/SKILL.md"
tags: ["hreflang", "check"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/hreflang-check`).
