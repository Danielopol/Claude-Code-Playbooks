...
seoHook: "The breakthrough for your research probably exists in a field you've never read — biologists solved the problem in 1998, or physicists have a framework that maps perfectly. But who has time to read papers in 15 other disciplines?"
targetAudience: "researchers stuck on hard problems who need fresh angles, PhD students looking for novel approaches, interdisciplinary scientists connecting disparate fields, R&D teams seeking innovation through cross-pollination, anyone who suspects the answer to their problem already exists somewhere else"
exampleUseCase: "\"Find cross-domain inspiration for our protein folding optimization problem\" → Problem decomposed into 5 sub-questions, literature searched across biology, materials science, and operations research — 8 transferable insights ranked by applicability, with source papers and adaptation strategies"
