...
description: "Import brand guidelines."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent import guidelines work — Import brand guidelines. Use when: adding voice guides, style restrictions, or messaging frameworks. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /import-guidelines for our brand\" → Import Guidelines workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "productivity"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/import-guidelines/SKILL.md"
tags: ["import", "guidelines"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/import-guidelines`).
