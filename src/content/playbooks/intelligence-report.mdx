...
description: "Generate marketing intelligence briefings."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent intelligence report work — Generate marketing intelligence briefings. Use when: reviewing learnings, cross-agent patterns, or playbooks. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "marketing analysts, growth analysts, BI leads"
exampleUseCase: "\"Run /intelligence-report for our brand\" → Intelligence Report workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "data-reporting"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/intelligence-report/SKILL.md"
...
Create a dedicated folder for this workflow (e.g. `~/marketing/intelligence-report`).
