...
seoHook: "Your invoices are Word documents with inconsistent formatting, you manually calculate tax every time, and international clients need different currencies. One invoice shouldn't take 20 minutes to create."
targetAudience: "freelancers invoicing multiple clients, small business owners without accounting software, consultants billing by project or hourly, agencies creating branded invoices for different services, anyone using Word or Google Docs as their invoicing tool"
exampleUseCase: "\"Generate an invoice for 40 hours of consulting at $150/hr for Acme Corp with 10% tax\" → Professional PDF invoice with your branding, itemized line items, tax calculation, payment terms, bank details, and sequential invoice numbering — ready to send in seconds"
