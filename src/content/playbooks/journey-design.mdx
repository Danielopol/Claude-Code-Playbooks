...
description: "Design cross-channel customer journeys."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent journey design work — Design cross-channel customer journeys. Use when: mapping touchpoints, branching logic, or stage transitions. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /journey-design for our brand\" → Journey Design workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/journey-design/SKILL.md"
tags: ["journey", "design"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/journey-design`).
