...
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent keyword research work — Research and cluster keywords. Use when: mapping search intent, finding content gaps, or long-tail discovery. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "SEO specialists, content marketers, technical SEO leads, growth marketers"
exampleUseCase: "\"Run /keyword-research for our brand\" → Keyword Research workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/keyword-research/SKILL.md"
...
Create a dedicated folder for this workflow (e.g. `~/marketing/keyword-research`).
