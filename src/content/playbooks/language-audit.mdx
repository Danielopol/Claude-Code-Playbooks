...
description: "Audit multilingual content consistency."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent language audit work — Audit multilingual content consistency. Use when: checking language parity, regional compliance, or translation quality. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /language-audit for our brand\" → Language Audit workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/language-audit/SKILL.md"
tags: ["language", "audit"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/language-audit`).
