...
description: "Launch paid ad campaigns."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent launch ad campaign work — Launch paid ad campaigns. Use when: deploying ads on Google, Meta, LinkedIn, or TikTok with targeting and safeguards. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "paid media managers, performance marketers, media buyers, growth marketers"
exampleUseCase: "\"Run /launch-ad-campaign for our brand\" → Launch Ad Campaign workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/launch-ad-campaign/SKILL.md"
...
Create a dedicated folder for this workflow (e.g. `~/marketing/launch-ad-campaign`).
