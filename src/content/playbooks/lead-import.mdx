...
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent lead import work — Import leads into CRM. Use when: loading leads from forms, CSV, or manual entry with deduplication and scoring. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "paid media managers, performance marketers, media buyers, growth marketers"
exampleUseCase: "\"Run /lead-import for our brand\" → Lead Import workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/lead-import/SKILL.md"
tags: ["lead", "import"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/lead-import`).
