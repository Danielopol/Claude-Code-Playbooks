...
seoHook: "You spend 30 minutes researching each prospect on LinkedIn and their company website, only to discover halfway through the call that they're not a fit. Multiply that by 20 prospects a week and you're losing a full day to research that could be systematized."
targetAudience: "SDRs spending too much time on prospect research, sales teams needing systematic lead qualification, BDRs building targeted outreach lists, account executives preparing for discovery calls, founders doing their own sales prospecting"
exampleUseCase: "\"Research and qualify these 25 companies as potential customers for our API monitoring tool\" → Each company scored by ICP fit (tech stack, team size, growth signals), key decision-maker identified with personalization hooks, and a tailored outreach angle for each — saving 10+ hours of manual research"
