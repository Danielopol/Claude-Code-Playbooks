---
title: "Learn"
description: "Save a marketing learning or insight."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent learn work — Save a marketing learning or insight. Use when: capturing knowledge, recording campaign results, building compound intelligence. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /learn for our brand\" → Learn workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "productivity"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/learn/SKILL.md"
tags: ["learn"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/learn`).
