...
seoHook: "You just received a 40-page vendor contract and your options are: sign it without reading (risky), spend $5,000 on outside counsel (expensive), or read it yourself and miss the liability clause buried in Section 12.3 (dangerous). You need a first pass that catches the important stuff."
targetAudience: "startup founders signing contracts without legal teams, small business owners reviewing vendor agreements, freelancers evaluating client contracts, non-lawyers who need to understand legal documents before escalating to counsel, anyone who signs contracts and worries about what they missed"
exampleUseCase: "\"Review this SaaS vendor agreement and flag anything concerning\" → Structured analysis: 5 high-risk clauses flagged (unlimited liability, auto-renewal, broad IP assignment), 3 missing protections (no SLA, no data deletion), plain-English explanations, and recommended negotiation points"
