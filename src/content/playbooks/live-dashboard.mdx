...
description: "Create live Looker Studio dashboards."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent live dashboard work — Create live Looker Studio dashboards. Use when: connecting marketing data sources with auto-configured visualizations. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "marketing analysts, growth analysts, BI leads"
exampleUseCase: "\"Run /live-dashboard for our brand\" → Live Dashboard workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "data-reporting"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/live-dashboard/SKILL.md"
tags: ["live", "dashboard"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/live-dashboard`).
