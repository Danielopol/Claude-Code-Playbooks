...
seoHook: "You're launching a B2B product and need 50 pilot customers in your city, but you're manually scrolling through Google Maps and copying business names into a spreadsheet. Three hours in, you have 12 leads and no idea if they actually fit your ICP."
targetAudience: "B2B startup founders finding first customers locally, sales development reps building territory lead lists, agency owners prospecting local businesses, SaaS companies targeting SMBs in specific geographies, freelancers finding local clients"
exampleUseCase: "\"Find 50 dental practices in Austin that might need our scheduling software\" → Qualified lead list with practice name, size estimate, current tech stack signals, contact info, and prioritization score based on ICP fit"
