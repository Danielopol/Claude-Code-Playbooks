---
title: "Localize Campaign"
description: "Localize campaigns for multiple markets."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent localize campaign work — Localize campaigns for multiple markets. Use when: translating assets, adapting references, adjusting compliance. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /localize-campaign for our brand\" → Localize Campaign workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/localize-campaign/SKILL.md"
tags: ["localize", "campaign"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/localize-campaign`).
