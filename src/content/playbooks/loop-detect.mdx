---
title: "Loop Detect"
description: "Identify and model growth loops."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent loop detect work — Identify and model growth loops. Use when: detecting viral, content, or paid loops, modeling effectiveness, proposing new loops. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /loop-detect for our brand\" → Loop Detect workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "productivity"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/loop-detect/SKILL.md"
tags: ["loop", "detect"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/loop-detect`).
