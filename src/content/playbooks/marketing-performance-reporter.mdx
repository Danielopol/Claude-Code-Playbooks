...
seoHook: "Every Monday you spend two hours pulling numbers from Google Analytics, Facebook Ads, and Mailchimp into a spreadsheet that nobody reads past slide three. Your CMO wants insights, not screenshots — and the data is stale by the time you present it."
targetAudience: "marketing managers reporting campaign performance to leadership, growth marketers tracking multi-channel metrics, marketing analysts building recurring performance dashboards, CMOs needing board-ready marketing reports, agency account managers reporting to clients"
exampleUseCase: "\"Generate our weekly marketing performance report\" → Cross-channel report with acquisition metrics, conversion funnels, spend efficiency by channel, week-over-week trends, top/bottom performing campaigns, and 3 specific optimization recommendations"
