---
title: "Media Plan"
description: "Create a paid media plan."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent media plan work — Create a paid media plan. Use when: building media buy schedules, cross-channel budget allocation, or creative rotation calendars. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "paid media managers, performance marketers, media buyers, growth marketers"
exampleUseCase: "\"Run /media-plan for our brand\" → Media Plan workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/media-plan/SKILL.md"
tags: ["media", "plan"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/media-plan`).
