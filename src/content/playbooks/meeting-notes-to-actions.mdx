...
seoHook: "You have a 90-minute meeting transcript and somewhere in 14 pages of conversation are the three things that actually matter. Manually scanning for action items, decisions, and owners takes almost as long as the meeting itself."
targetAudience: "project managers processing meeting transcripts into task assignments, team leads extracting action items from standup notes, executive assistants summarizing leadership meetings, product managers turning stakeholder calls into next steps, anyone who takes meeting notes and needs to extract what's actionable"
exampleUseCase: "\"Extract action items from this product review transcript\" → Structured summary with key decisions, 8 action items with assigned owners and due dates, unresolved questions flagged for follow-up, and a formatted Slack message for the team channel"
