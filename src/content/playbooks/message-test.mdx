---
title: "Message Test"
description: "Test message variants on synthetic audiences."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent message test work — Test message variants on synthetic audiences. Use when: predicting response rates, sentiment, or objections before live tests. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /message-test for our brand\" → Message Test workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/message-test/SKILL.md"
tags: ["message", "test"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/message-test`).
