...
description: "Track AI engine brand narratives."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent narrative tracker work — Track AI engine brand narratives. Use when: detecting narrative drift, misrepresentation, or competitor narrative gains over time. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /narrative-tracker for our brand\" → Narrative Tracker workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/narrative-tracker/SKILL.md"
tags: ["narrative", "tracker"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/narrative-tracker`).
