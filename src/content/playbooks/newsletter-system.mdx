...
seoHook: "Every newsletter issue starts with a blank page and the dread of repeating a topic you covered two months ago. You can't remember your own voice across 30 issues, your template drifts with every edition, and consistency is what keeps subscribers engaged."
targetAudience: "solo newsletter creators maintaining a consistent publishing schedule, content marketers managing company newsletters, community managers sending regular member updates, thought leaders building audience through weekly emails, creators growing paid newsletter businesses"
exampleUseCase: "\"Help me draft this week's newsletter issue\" → Draft matching your established voice and template, auto-checked against past 20 issues for topic overlap, with subject line variants, preview text, and a tracking log of topics covered"
