...
seoHook: "You add backlinks when you remember, your frontmatter has five different date formats, and 200 orphan notes sit disconnected from everything. Vault maintenance is the kind of work that's important but never urgent — so it never gets done."
targetAudience: "Obsidian users whose vaults have grown messy over months of use, PKM enthusiasts wanting automated vault hygiene, students maintaining course note vaults across semesters, researchers needing consistent metadata across literature notes, professionals using Obsidian for project documentation"
exampleUseCase: "\"Clean up and organize my Obsidian vault\" → Automated backlinking for 150 orphan notes, frontmatter standardized across all files, related note suggestions for 50 isolated entries, and a vault summary showing topic distribution and connection density"
