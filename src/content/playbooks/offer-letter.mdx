...
seoHook: "Every offer letter you send is copy-pasted from the last one with manual find-and-replace for names, titles, and compensation. You've sent the wrong salary once and the wrong name twice. A proper template system would prevent these errors but you haven't built one."
targetAudience: "small business owners hiring without formal HR processes, HR coordinators producing high volumes of offer letters, recruiting agencies generating offers for multiple clients, office managers handling hiring paperwork, people ops teams building scalable hiring workflows"
exampleUseCase: "\"Generate an offer letter for our new Marketing Manager\" → Formal offer letter with role details, compensation breakdown, benefits overview, reporting structure, start date, acceptance deadline, and standard employment terms formatted to your company letterhead"
