...
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent pdf report work — Generate branded PDF reports. Use when: creating executive summaries, campaign reports, or client deliverables. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "marketing analysts, growth analysts, BI leads"
exampleUseCase: "\"Run /pdf-report for our brand\" → Pdf Report workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "data-reporting"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/pdf-report/SKILL.md"
tags: ["pdf", "report"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/pdf-report`).
