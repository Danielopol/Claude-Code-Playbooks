...
description: "Pull live metrics for a performance snapshot."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent performance check work — Pull live metrics for a performance snapshot. Use when: checking KPIs, trends, or comparisons to targets across platforms. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /performance-check for our brand\" → Performance Check workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "data-reporting"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/performance-check/SKILL.md"
tags: ["performance", "check"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/performance-check`).
