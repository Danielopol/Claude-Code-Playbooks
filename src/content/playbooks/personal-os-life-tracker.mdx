...
seoHook: "Your habits are in one app, tasks in another, fitness data on your watch, and daily reflections in a journal you forget to open. Nothing talks to anything else. You want a single system that tracks your whole life — and actually shows you if you're making progress."
targetAudience: "quantified self enthusiasts tracking multiple life dimensions, productivity-focused professionals building a personal operating system, people using Obsidian or plain markdown for life management, fitness-minded professionals integrating health data with daily planning, anyone who wants one system to rule their habits, tasks, and goals"
exampleUseCase: "\"Build me a personal OS to track my habits, fitness, and daily tasks\" → Markdown-based life tracker with daily log templates, habit streak tracking, fitness data integration, task management with priorities, automated weekly reviews with trend analysis, and a simple daily review workflow"
