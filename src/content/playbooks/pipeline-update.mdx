...
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent pipeline update work — Update CRM pipeline. Use when: changing deal stages, values, notes, tracking velocity, or managing deal progression. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /pipeline-update for our brand\" → Pipeline Update workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "sales-revenue"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/pipeline-update/SKILL.md"
...
Create a dedicated folder for this workflow (e.g. `~/marketing/pipeline-update`).
