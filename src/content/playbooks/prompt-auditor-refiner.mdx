...
seoHook: "Your CLAUDE.md prompt gets mediocre results and you don't know why. Is it too vague? Too long? Missing constraints? You could rewrite it from scratch, but a targeted audit would tell you exactly which parts are weak and how to fix them without losing what works."
targetAudience: "developers optimizing their CLAUDE.md files for better Claude Code output, prompt engineers refining system prompts for production AI applications, teams standardizing prompt quality across projects, power users getting inconsistent results from their prompts, anyone who has a working prompt that could be significantly better"
exampleUseCase: "\"Audit and improve my project's CLAUDE.md prompt\" → Quality scorecard rating 8 dimensions (clarity, specificity, constraints, examples, etc.), 5 targeted improvements with before/after comparisons, and a refined version that addresses the weakest areas"
