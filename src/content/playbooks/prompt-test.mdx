---
title: "Prompt Test"
description: "A/B test content variations."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent prompt test work — A/B test content variations. Use when: comparing quality scores across prompt approaches, headline styles, or content versions. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /prompt-test for our brand\" → Prompt Test workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "data-reporting"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/prompt-test/SKILL.md"
tags: ["prompt", "test"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/prompt-test`).
