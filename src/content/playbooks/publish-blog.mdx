...
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent publish blog work — Publish blog posts. Use when: deploying to WordPress or Webflow with SEO optimization, categories, and scheduling. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "content marketers, content strategists, editors"
exampleUseCase: "\"Run /publish-blog for our brand\" → Publish Blog workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/publish-blog/SKILL.md"
tags: ["publish", "blog"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/publish-blog`).
