...
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent qbr plan work — Prepare a Quarterly Business Review. Use when: building QBR presentations, client performance reviews, or strategy updates. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "agency owners, account managers, consultants"
exampleUseCase: "\"Run /qbr-plan for our brand\" → Qbr Plan workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "sales-revenue"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/qbr-plan/SKILL.md"
tags: ["qbr", "plan"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/qbr-plan`).
