...
description: "Generate quality trends report."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent quality report work — Generate quality trends report. Use when: reviewing eval scores over time, content type performance, or regression alerts. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "marketing analysts, growth analysts, BI leads"
exampleUseCase: "\"Run /quality-report for our brand\" → Quality Report workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "data-reporting"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/quality-report/SKILL.md"
tags: ["quality", "report"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/quality-report`).
