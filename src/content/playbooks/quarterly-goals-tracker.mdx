...
seoHook: "You set ambitious quarterly goals in January and by March you can't remember half of them. The ones you do remember have no measurable progress because tracking happens in your head. Every quarter ends with 'I think we made progress' instead of knowing exactly where you stand."
targetAudience: "professionals tracking OKRs or quarterly goals for performance reviews, managers monitoring team objectives across the quarter, entrepreneurs holding themselves accountable to business milestones, remote workers who need structure for self-directed goal tracking, anyone who sets goals but struggles with consistent progress measurement"
exampleUseCase: "\"Set up tracking for my Q2 goals\" → Goal tracking system with 5 objectives scored on evidence-based progress, weekly check-in prompts, deadline alerts, evidence collection from git commits and project files, and a quarter-end review template with honest assessment"
