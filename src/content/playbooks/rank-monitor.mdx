...
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent rank monitor work — Monitor keyword rankings. Use when: tracking keyword positions, detecting ranking drops, or alerting on position changes. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "SEO specialists, content marketers, technical SEO leads, growth marketers"
exampleUseCase: "\"Run /rank-monitor for our brand\" → Rank Monitor workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/rank-monitor/SKILL.md"
tags: ["rank", "monitor"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/rank-monitor`).
