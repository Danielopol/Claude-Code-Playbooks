...
targetAudience: "senior engineers writing design documents for complex features, technical leads defining architecture for new systems, staff engineers creating specs that align multiple teams, engineering managers establishing spec-writing culture, platform engineers documenting API contracts and interface definitions"
exampleUseCase: "\"Write a technical spec for our new notification system\" → Complete spec: problem statement and goals, architecture decision with alternatives considered, API interface definitions with request/response schemas, database schema design, sequence diagrams for key flows, edge case analysis, rollout plan, and success metrics"
