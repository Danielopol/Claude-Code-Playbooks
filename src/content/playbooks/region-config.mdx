...
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent region config work — Configure regional settings. Use when: setting timezone, language, compliance rules, currency, or local preferences. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /region-config for our brand\" → Region Config workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "productivity"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/region-config/SKILL.md"
tags: ["region", "config"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/region-config`).
