...
description: "Design retargeting strategy."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent retargeting strategy work — Design retargeting strategy. Use when: planning cross-platform remarketing, audience segmentation, or ad sequencing. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "paid media managers, performance marketers, media buyers, growth marketers"
exampleUseCase: "\"Run /retargeting-strategy for our brand\" → Retargeting Strategy workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/retargeting-strategy/SKILL.md"
...
Create a dedicated folder for this workflow (e.g. `~/marketing/retargeting-strategy`).
