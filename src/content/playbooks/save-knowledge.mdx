...
description: "Save brand knowledge to memory."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent save knowledge work — Save brand knowledge to memory. Use when: persisting campaign learnings, guidelines, or competitive intel for retrieval. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /save-knowledge for our brand\" → Save Knowledge workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "productivity"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/save-knowledge/SKILL.md"
tags: ["save", "knowledge"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/save-knowledge`).
