...
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent schedule social work — Schedule social media posts. Use when: publishing to Twitter/X, Instagram, LinkedIn, TikTok, YouTube, or Pinterest. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "social media managers, influencer marketing leads, content strategists"
exampleUseCase: "\"Run /schedule-social for our brand\" → Schedule Social workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/schedule-social/SKILL.md"
...
Create a dedicated folder for this workflow (e.g. `~/marketing/schedule-social`).
