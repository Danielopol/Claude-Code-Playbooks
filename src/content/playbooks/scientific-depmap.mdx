---
title: "Scientific Depmap"
description: "Query the Cancer Dependency Map (DepMap) for cancer cell line gene dependency scores (CRISPR Chronos), drug sensitivity data, and gene effect profiles. Use for identifying cancer-specific vulnerabilities, synthetic lethal interactions, and validat..."
seoHook: "Is your drug target essential in cancer cells but not in normal tissue? DepMap answers this with CRISPR knockout data across 1,000+ cancer cell lines. Querying dependency scores, drug sensitivity, and gene effect profiles programmatically lets you validate targets and identify synthetic lethal partners at scale."
targetAudience: "oncology drug discovery scientists validating target essentiality across cancer lineages, cancer biologists identifying synthetic lethal interactions for therapeutic development, translational researchers matching genetic dependencies to patient populations, computational biologists building predictive models of cancer vulnerabilities, graduate students exploring cancer dependency data for thesis projects"
exampleUseCase: "\"Query DepMap for dependency scores of our 5 candidate drug targets\" → Target validation report: CRISPR Chronos dependency scores across cancer lineages, selectivity analysis (cancer vs. non-essential), co-dependency network for synthetic lethality candidates, drug sensitivity correlation data, and a ranked target prioritization summary"
category: "academic-research"
difficulty: "beginner"
timeToSetup: "5 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/depmap"
tags: ["scientific", "claude-code", "depmap", "bioinformatics", "chemistry", "statistics", "database", "protein"]
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/depmap/
```
