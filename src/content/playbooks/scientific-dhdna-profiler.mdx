---
title: "Scientific Dhdna Profiler"
description: "Extract cognitive patterns and thinking fingerprints from any text. Use this skill when the user wants to analyze how someone thinks, understand cognitive style, profile writing or speech patterns, compare thinking styles between people, asks 'wha..."
seoHook: "Every writer and thinker has cognitive patterns — how they structure arguments, handle uncertainty, make connections, and weigh evidence. Extracting these thinking fingerprints from text reveals cognitive styles that are invisible to casual reading, useful for understanding authorship, communication preferences, and intellectual approaches."
targetAudience: "cognitive scientists studying thinking patterns in written language, organizational psychologists profiling communication styles for team dynamics, researchers analyzing authorial voice and argumentation patterns, educators understanding student cognitive development through writing, forensic linguists studying textual attribution and authorship"
exampleUseCase: "\"Profile the cognitive patterns in these 5 research papers by different authors\" → Cognitive analysis per author: argumentation structure patterns, uncertainty handling style, evidence weighting preferences, abstraction level tendencies, cross-domain connection frequency, and a comparative fingerprint showing how each author's thinking style differs"
category: "academic-research"
difficulty: "advanced"
timeToSetup: "15 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/dhdna-profiler"
tags: ["scientific", "claude-code", "dhdna-profiler", "bioinformatics", "visualization", "database", "protein", "genomics"]
createdAt: "2026-03-06"
---

## What This Does

A scientific skill for dhdna profiler workflows with Claude Code.
...
```bash
mkdir -p ~/Projects/dhdna-profiler
```
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/dhdna-profiler/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/dhdna-profiler
claude
```
...
- **Read the docs**: Check the official dhdna-profiler documentation for latest API changes
