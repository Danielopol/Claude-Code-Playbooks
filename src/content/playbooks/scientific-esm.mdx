---
title: "Scientific Esm"
description: "Comprehensive toolkit for protein language models including ESM3 (generative multimodal protein design across sequence, structure, and function) and ESM C (efficient protein embeddings and representations). Use this skill when working with protein..."
seoHook: "Protein engineering used to require years of directed evolution in the lab. ESM protein language models can generate novel proteins, predict structure from sequence, and compute embeddings that capture evolutionary relationships — enabling computational protein design that would have been science fiction five years ago."
targetAudience: "protein engineers using AI for de novo protein design, structural biologists predicting protein structure and function from sequence, computational biologists computing protein embeddings for downstream ML, synthetic biologists designing novel enzymes and binders, bioinformatics researchers leveraging protein language models for annotation"
exampleUseCase: "\"Use ESM3 to design novel variants of our therapeutic protein\" → Protein design workflow: ESM3 multimodal generation conditioned on desired structure and function, variant library with predicted stability and function scores, ESM C embeddings for clustering and visualization, structure predictions for top candidates, and a ranked design list for experimental validation"
...
tags: ["scientific", "claude-code", "esm", "machine-learning", "chemistry", "database", "protein", "genomics"]
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/esm/
```
