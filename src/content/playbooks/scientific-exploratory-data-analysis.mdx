---
title: "Scientific Exploratory Data Analysis"
...
seoHook: "You received a dataset in a format you've never seen before and need to understand its structure, quality, and content before you can analyze it. Automated EDA across 200+ scientific file formats gives you distributions, missing data patterns, correlations, and anomalies — the foundation you need before any serious analysis."
targetAudience: "data scientists starting analysis on unfamiliar datasets, researchers receiving data from collaborators in varied formats, bioinformaticians profiling new datasets before pipeline development, analysts performing data quality assessment on incoming data, graduate students learning exploratory data analysis techniques"
exampleUseCase: "\"Run EDA on this proteomics dataset I received from a collaborator\" → Comprehensive EDA report: file format detection and parsing, variable type classification, distribution summaries with outlier detection, missing data pattern analysis, correlation matrix for numeric variables, data quality score, and recommended preprocessing steps"
...
tags: ["scientific", "claude-code", "exploratory-data-analysis", "bioinformatics", "chemistry", "statistics", "visualization", "database"]
...
```bash
mkdir -p ~/Projects/exploratory-data-analysis
```
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/exploratory-data-analysis/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/exploratory-data-analysis
claude
```
