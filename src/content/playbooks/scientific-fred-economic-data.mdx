---
title: "Scientific Fred Economic Data"
...
seoHook: "You need 20 years of monthly CPI data, unemployment rates by state, and yield curve history — but each data point lives on a different government website. FRED aggregates 800,000+ economic time series from 100+ sources into a single API, making macroeconomic analysis as easy as a function call."
targetAudience: "economists building macroeconomic models with historical data, financial analysts tracking economic indicators for investment decisions, data journalists creating economic data visualizations, policy researchers studying economic trends and their impacts, quantitative strategists incorporating macro data into trading models"
exampleUseCase: "\"Pull inflation, unemployment, and GDP data for a recession probability model\" → FRED data pipeline: historical CPI, unemployment rate, real GDP, and yield curve spread data with configurable date ranges, seasonal adjustment options, frequency alignment across series, formatted output for time series modeling, and a summary statistics dashboard"
category: "finance"
difficulty: "beginner"
timeToSetup: "5 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/fred-economic-data"
tags: ["scientific", "claude-code", "fred-economic-data", "chemistry", "visualization", "database", "finance"]
...
```bash
mkdir -p ~/Projects/fred-economic-data
```
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/fred-economic-data/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/fred-economic-data
claude
```
...
- **Read the docs**: Check the official fred-economic-data documentation for latest API changes
