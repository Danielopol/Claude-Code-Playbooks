---
title: "Scientific Generate Image"
description: "Generate or edit images using AI models (FLUX, Nano Banana 2). Use for general-purpose image generation including photos, illustrations, artwork, visual assets, concept art, and any image that is not a technical diagram or schematic. For flowchart..."
seoHook: "You need a custom illustration, concept visualization, or creative asset but don't have a designer on call or the budget for stock photography. AI image generation with FLUX and other models lets you go from text description to high-quality visuals — iterating on style, composition, and content until you get exactly what you need."
targetAudience: "content creators needing custom visuals for articles and social media, researchers generating scientific illustrations and concept diagrams, marketers creating visual assets without waiting for design team turnaround, educators producing custom educational imagery, product teams creating mockups and concept art for presentations"
exampleUseCase: "\"Generate a hero image for our blog post about protein folding\" → AI-generated image: FLUX-generated visualization matching your description, multiple style variations to choose from, resolution suitable for web or print, iterative refinement based on feedback, and final output in publication-ready format"
...
tags: ["scientific", "claude-code", "generate-image", "bioinformatics", "machine-learning", "visualization", "database", "protein"]
createdAt: "2026-03-06"
---

## What This Does

A scientific skill for generate image workflows with Claude Code.
...
```bash
mkdir -p ~/Projects/generate-image
```
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/generate-image/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/generate-image
claude
```
...
- **Read the docs**: Check the official generate-image documentation for latest API changes
