...
seoHook: "Your earth observation project needs satellite imagery processing, spatial analysis, and ML-based classification — but each requires different tools with incompatible formats. A unified geospatial science framework covering remote sensing, GIS, and 30+ scientific domains lets you go from raw Sentinel/Landsat imagery to publishable maps in one workflow."
targetAudience: "remote sensing scientists processing satellite imagery for environmental monitoring, GIS analysts performing spatial analysis and map production, earth observation researchers applying ML to Sentinel and Landsat data, environmental scientists studying land use change and vegetation indices, geospatial data engineers building automated imagery pipelines"
exampleUseCase: "\"Process Sentinel-2 imagery to create a land cover classification map\" → Geospatial pipeline: satellite image acquisition and preprocessing, spectral index computation (NDVI, NDWI), training data preparation and ML classification, accuracy assessment with confusion matrix, and publication-ready map output with legend and scale bar"
category: "data-reporting"
difficulty: "beginner"
timeToSetup: "5 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/geomaster"
tags: ["scientific", "claude-code", "geomaster", "machine-learning", "visualization", "database", "protein", "genomics"]
createdAt: "2026-03-06"
---

## What This Does

A scientific skill for geomaster workflows with Claude Code.
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/geomaster/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/geomaster
claude
```
