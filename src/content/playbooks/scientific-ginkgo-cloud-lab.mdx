---
title: "Scientific Ginkgo Cloud Lab"
...
seoHook: "You've designed a cell-free protein expression experiment but running it means booking bench time, manual pipetting, and days of waiting. Ginkgo Cloud Lab lets you submit protocols for autonomous execution on robotic systems — getting results without setting foot in a physical lab."
targetAudience: "synthetic biologists running cell-free protein expression experiments remotely, biotech startups prototyping constructs without building wet lab infrastructure, protein engineers validating designs through cloud-based automated experiments, academic researchers accessing robotic lab capabilities for high-throughput screening, computational biologists closing the design-build-test loop with automated execution"
exampleUseCase: "\"Run our cell-free expression validation on Ginkgo Cloud Lab\" → Cloud lab workflow: protocol configuration for cell-free protein expression, plate layout and sample mapping, automated submission to Ginkgo's robotic execution platform, real-time run monitoring and status tracking, and results retrieval with expression level analysis"
category: "academic-research"
difficulty: "intermediate"
timeToSetup: "10 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/ginkgo-cloud-lab"
tags: ["scientific", "claude-code", "ginkgo-cloud-lab", "visualization", "database", "protein", "genomics"]
...
```bash
mkdir -p ~/Projects/ginkgo-cloud-lab
```
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/ginkgo-cloud-lab/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/ginkgo-cloud-lab
claude
```
...
- **Read the docs**: Check the official ginkgo-cloud-lab documentation for latest API changes
