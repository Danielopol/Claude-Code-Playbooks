---
title: "Scientific Gnomad Database"
description: "Query gnomAD (Genome Aggregation Database) for population allele frequencies, variant constraint scores (pLI, LOEUF), and loss-of-function intolerance. Essential for variant pathogenicity interpretation, rare disease genetics, and identifying loss..."
seoHook: "A clinical lab flags a missense variant as 'uncertain significance' and you need population frequency data to help classify it. gnomAD aggregates allele frequencies from 800,000+ individuals across diverse populations — making it the gold standard for distinguishing rare pathogenic variants from benign polymorphisms."
targetAudience: "clinical geneticists interpreting variant pathogenicity using population allele frequencies, rare disease researchers filtering candidate variants against population databases, genetic counselors assessing variant significance for patient reports, bioinformaticians building variant annotation pipelines with constraint scores, human genetics researchers studying gene-level loss-of-function intolerance"
exampleUseCase: "\"Check our candidate variants against gnomAD for population frequencies and gene constraint\" → gnomAD query: variant lookup with allele frequencies across populations, gene constraint scores (pLI, LOEUF) for loss-of-function intolerance, filtering against population frequency thresholds, cross-population frequency comparison, and an annotated variant table with pathogenicity evidence"
category: "academic-research"
difficulty: "beginner"
timeToSetup: "5 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/gnomad-database"
tags: ["scientific", "claude-code", "gnomad-database", "bioinformatics", "visualization", "database", "protein", "genomics"]
