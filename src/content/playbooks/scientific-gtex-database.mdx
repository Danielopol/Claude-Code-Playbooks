---
title: "Scientific Gtex Database"
...
seoHook: "Your GWAS hit is in a non-coding region and you need to know which gene it regulates and in which tissues. GTEx provides tissue-specific expression data and eQTL maps from 1,000+ donors across 54 tissues — the key resource for linking genetic variants to gene regulation in specific cell types."
targetAudience: "human geneticists interpreting GWAS variants through tissue-specific eQTL data, transcriptomics researchers studying tissue-specific gene expression patterns, clinical researchers linking genetic variants to gene regulation in disease-relevant tissues, computational biologists building multi-tissue gene regulatory models, pharmacogenomics researchers identifying tissue-specific drug target expression"
exampleUseCase: "\"Look up tissue expression and eQTLs for our GWAS candidate genes\" → GTEx query: tissue-specific expression profiles across 54 tissues, eQTL associations linking variants to gene expression changes, sQTL data for splicing effects, multi-tissue expression comparison visualization, and an integrated report connecting your GWAS variants to regulatory mechanisms"
category: "academic-research"
difficulty: "beginner"
timeToSetup: "5 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/gtex-database"
tags: ["scientific", "claude-code", "gtex-database", "bioinformatics", "statistics", "database", "genomics", "writing"]
...
```bash
mkdir -p ~/Projects/gtex-database
```
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/gtex-database/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/gtex-database
claude
```
