---
title: "Scientific Histolab"
description: "Lightweight WSI tile extraction and preprocessing. Use for basic slide processing tissue detection, tile extraction, stain normalization for H&E images. Best for simple pipelines, dataset preparation, quick tile-based analysis. For advanced spatia..."
seoHook: "You have whole-slide images from pathology but need to extract thousands of tiles for training a deep learning classifier. Histolab automates tissue detection, tile extraction, and H&E stain normalization from WSIs — turning gigapixel pathology images into ML-ready datasets without writing custom preprocessing code."
targetAudience: "computational pathologists building deep learning models on whole-slide images, pathology researchers preparing tile datasets for tissue classification, medical imaging scientists normalizing H&E staining across slide batches, digital pathology engineers building automated slide processing pipelines, graduate students learning computational pathology with accessible Python tools"
exampleUseCase: "\"Extract tissue tiles from our H&E whole-slide images for training a tumor classifier\" → Histolab pipeline: automatic tissue region detection on WSIs, grid-based tile extraction at specified magnification, H&E stain normalization across slides, quality filtering to remove background and artifact tiles, and organized tile dataset ready for deep learning training"
...
tags: ["scientific", "claude-code", "histolab", "machine-learning", "visualization", "database", "protein", "genomics"]
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/histolab/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/histolab
claude
```
