---
title: "Scientific Iso 13485 Certification"
...
seoHook: "Preparing for ISO 13485 certification means producing hundreds of pages of QMS documentation — quality manuals, SOPs, risk management files, and design controls — with every clause accounted for. A structured certification toolkit generates compliant document templates and identifies gaps before the auditor does."
targetAudience: "quality assurance managers preparing medical device companies for ISO 13485 certification, regulatory affairs specialists building Quality Management System documentation, medical device startups establishing compliant quality systems from scratch, quality engineers conducting internal audits and gap analyses against ISO 13485 requirements, consultants helping clients achieve medical device QMS certification"
exampleUseCase: "\"Prepare our ISO 13485 QMS documentation for upcoming certification audit\" → Certification toolkit: gap analysis of existing documentation against ISO 13485 clauses, quality manual and SOP template generation, design control and risk management file frameworks, internal audit checklist preparation, and a prioritized remediation plan for identified non-conformities"
...
tags: ["scientific", "claude-code", "iso-13485-certification", "visualization", "protein", "genomics", "finance", "writing"]
...
```bash
mkdir -p ~/Projects/iso-13485-certification
```
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/iso-13485-certification/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/iso-13485-certification
claude
```
