---
title: "Scientific Market Research Reports"
...
seoHook: "A McKinsey-quality market research report takes weeks to research, write, and design — but your stakeholders need it for next week's board meeting. Automated report generation produces 50+ page consulting-grade documents with professional LaTeX formatting, data-driven visuals, and structured analysis sections."
targetAudience: "management consultants producing market analysis deliverables for client engagements, product managers researching market size and competitive landscape for strategic planning, venture capital analysts conducting market due diligence on investment opportunities, corporate strategy teams building industry landscape reports for executive leadership, startup founders creating investor-ready market analysis for fundraising decks"
exampleUseCase: "\"Generate a comprehensive market research report on the synthetic biology tools market\" → Market report: executive summary with key findings, market sizing and growth projections with data visualizations, competitive landscape analysis with positioning maps, technology trend analysis, customer segment profiles, and a professionally formatted 50+ page LaTeX document"
...
tags: ["scientific", "claude-code", "market-research-reports", "bioinformatics", "visualization", "database", "protein", "genomics"]
...
```bash
mkdir -p ~/Projects/market-research-reports
```
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/market-research-reports/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/market-research-reports
claude
```
...
- **Read the docs**: Check the official market-research-reports documentation for latest API changes
