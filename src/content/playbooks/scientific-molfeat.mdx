...
seoHook: "Your QSAR model needs molecular features but choosing between ECFP, MACCS, RDKit descriptors, and pretrained models like ChemBERTa is overwhelming — each with different APIs and output formats. molfeat provides 100+ featurizers through a single unified interface, converting SMILES to ML-ready feature vectors in one line."
targetAudience: "cheminformatics scientists building QSAR and QSPR models with molecular features, drug discovery ML engineers comparing fingerprint and descriptor representations, computational chemists using pretrained molecular embeddings for property prediction, medicinal chemists exploring structure-activity relationships with molecular descriptors, AI researchers benchmarking molecular representations for chemistry tasks"
exampleUseCase: "\"Featurize our compound library with multiple representations for QSAR model comparison\" → molfeat pipeline: SMILES validation and standardization, parallel featurization with ECFP, MACCS keys, RDKit descriptors, and ChemBERTa embeddings, feature matrix generation for each representation, model training and comparison across representations, and a benchmark report identifying the best features for your property prediction task"
category: "academic-research"
difficulty: "intermediate"
timeToSetup: "10 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/molfeat"
tags: ["scientific", "claude-code", "molfeat", "machine-learning", "chemistry", "visualization", "database", "protein"]
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/molfeat/
```
...
- **Read the docs**: Check the official molfeat documentation for latest API changes
