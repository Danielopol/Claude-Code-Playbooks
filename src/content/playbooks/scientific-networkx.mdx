...
seoHook: "You have relational data — protein interactions, citation networks, social connections, or supply chains — but need to compute centrality, detect communities, and find shortest paths. NetworkX provides graph algorithms and visualization for any network analysis task, from small research graphs to large-scale network science."
targetAudience: "systems biologists analyzing protein-protein interaction and gene regulatory networks, social network researchers studying community structure and information diffusion, transportation engineers analyzing road and logistics networks, computational biologists building and analyzing biological pathway graphs, data scientists performing network-based feature engineering for ML models"
exampleUseCase: "\"Analyze our protein interaction network to find hub proteins and functional modules\" → NetworkX workflow: network construction from interaction data, centrality analysis (degree, betweenness, PageRank) to identify hub proteins, community detection for functional module discovery, shortest path analysis between proteins of interest, and network visualization with node coloring by community and sizing by centrality"
category: "data-reporting"
difficulty: "intermediate"
timeToSetup: "10 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/networkx"
tags: ["scientific", "claude-code", "networkx", "visualization", "database", "protein", "genomics", "writing"]
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/networkx/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/networkx
claude
```
...
- **Read the docs**: Check the official networkx documentation for latest API changes
