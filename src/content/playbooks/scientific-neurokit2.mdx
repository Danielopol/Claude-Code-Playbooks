...
seoHook: "Your experiment recorded ECG, EDA, and respiration simultaneously but each signal type needs different preprocessing, peak detection, and feature extraction methods. NeuroKit2 handles all major biosignal types — ECG, EEG, EDA, EMG, PPG, RSP — through a unified Python API with automated artifact correction and feature computation."
targetAudience: "psychophysiology researchers processing multi-modal biosignal recordings from experiments, neuroscientists analyzing EEG data for event-related potentials and frequency analysis, biomedical engineers developing wearable sensor data processing pipelines, clinical researchers extracting heart rate variability features from ECG recordings, human factors researchers measuring physiological stress responses through EDA and respiration"
exampleUseCase: "\"Process our experiment's ECG and EDA recordings to extract stress-related features\" → NeuroKit2 pipeline: signal loading and quality assessment, ECG R-peak detection and heart rate variability feature extraction, EDA decomposition into tonic and phasic components, respiration rate extraction from RSP signal, and a combined feature matrix with event-locked physiological responses ready for statistical analysis"
category: "academic-research"
difficulty: "intermediate"
timeToSetup: "10 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/neurokit2"
tags: ["scientific", "claude-code", "neurokit2", "visualization", "database", "genomics"]
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/neurokit2/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/neurokit2
claude
```
...
- **Read the docs**: Check the official neurokit2 documentation for latest API changes
