---
title: "Scientific Neuropixels Analysis"
...
seoHook: "Your Neuropixels recording has thousands of channels and millions of spikes that need sorting, quality control, and analysis — a pipeline that takes weeks to set up from scratch. This workflow handles the full chain from SpikeGLX/OpenEphys raw data through Kilosort4 spike sorting to curated single-unit analysis."
targetAudience: "systems neuroscientists analyzing Neuropixels recordings from behaving animals, electrophysiologists performing spike sorting and unit quality assessment, neuroscience graduate students setting up their first Neuropixels analysis pipeline, core facility staff supporting researchers with high-density probe recordings, computational neuroscientists developing analysis methods for large-scale neural recordings"
exampleUseCase: "\"Process our Neuropixels 2.0 recording through spike sorting and generate quality metrics\" → Neuropixels pipeline: SpikeGLX data loading and preprocessing with motion correction, Kilosort4 spike sorting with parameter optimization, unit quality metrics computation (ISI violations, amplitude cutoffs), Allen/IBL-standard curation criteria application, and sorted unit visualization with waveforms and firing rate maps"
category: "academic-research"
difficulty: "advanced"
timeToSetup: "15 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/neuropixels-analysis"
tags: ["scientific", "claude-code", "neuropixels-analysis", "visualization", "database", "protein", "genomics", "writing"]
...
```bash
mkdir -p ~/Projects/neuropixels-analysis
```
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/neuropixels-analysis/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/neuropixels-analysis
claude
```
...
- **Read the docs**: Check the official neuropixels-analysis documentation for latest API changes
