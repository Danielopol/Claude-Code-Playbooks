---
title: "Scientific Open Notebook"
...
seoHook: "You want AI-powered research notebooks like Google NotebookLM but need to keep your data on your own servers for privacy and compliance. Open Notebook is a self-hosted alternative that ingests PDFs, videos, audio, and web pages into searchable notebooks with AI-powered Q&A and summarization."
targetAudience: "researchers needing AI-powered document analysis with data privacy and self-hosting, graduate students organizing literature and research materials into searchable notebooks, science writers synthesizing information from diverse sources into coherent narratives, research teams building shared knowledge bases from papers and reports, institutions requiring on-premises AI tools for sensitive research documents"
exampleUseCase: "\"Set up Open Notebook to organize and query our research papers and protocols\" → Open Notebook deployment: self-hosted installation with local LLM configuration, notebook creation with PDF and document ingestion, AI-powered Q&A across ingested research materials, source-linked summarization and synthesis, and multi-user notebook sharing for collaborative research"
category: "research-writing"
difficulty: "intermediate"
timeToSetup: "10 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/open-notebook"
tags: ["scientific", "claude-code", "open-notebook", "bioinformatics", "visualization", "database", "protein", "genomics"]
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/open-notebook/
```
...
- **Read the docs**: Check the official open-notebook documentation for latest API changes
