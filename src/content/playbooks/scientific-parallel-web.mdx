...
seoHook: "Deep research requires synthesizing information from dozens of web sources — but manual searching, reading, and note-taking takes hours per topic. The Parallel Chat and Extract APIs run concurrent web searches and content extraction, delivering synthesized summaries with citations in minutes instead of hours."
targetAudience: "researchers conducting rapid literature and web surveys for background information, analysts performing multi-source competitive intelligence gathering, science writers synthesizing web content into coherent technical narratives, developers building research automation tools with web search and extraction capabilities, consultants gathering and synthesizing information from multiple online sources for client deliverables"
exampleUseCase: "\"Research the current landscape of protein language models and summarize key approaches\" → Parallel web research: concurrent searches across academic and industry sources, content extraction from relevant papers and blog posts, synthesized summary with key approaches and their trade-offs, citation tracking for all sources used, and a structured research report with linked references"
category: "developer-tools"
difficulty: "intermediate"
timeToSetup: "10 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/parallel-web"
tags: ["scientific", "claude-code", "parallel-web", "statistics", "visualization", "database", "protein", "genomics"]
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/parallel-web/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/parallel-web
claude
```
...
- **Read the docs**: Check the official parallel-web documentation for latest API changes
