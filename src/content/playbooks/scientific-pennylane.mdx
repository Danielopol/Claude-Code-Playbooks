...
seoHook: "Your quantum computing experiment needs to run on IBM, Google, and IonQ hardware — but each vendor has a different SDK and circuit format. PennyLane provides a hardware-agnostic quantum ML framework with automatic differentiation, letting you write circuits once and deploy them to any quantum backend."
targetAudience: "quantum computing researchers building variational quantum algorithms with gradient-based optimization, quantum chemistry scientists running VQE and molecular simulations on quantum hardware, ML researchers exploring hybrid quantum-classical neural network architectures, physics students learning quantum computing through hands-on circuit programming, quantum software engineers developing portable code across IBM/Google/Rigetti/IonQ backends"
exampleUseCase: "\"Build a variational quantum eigensolver for our molecular Hamiltonian\" → PennyLane workflow: molecular Hamiltonian construction from atomic coordinates, variational quantum circuit design with parameterized gates, gradient-based optimization of circuit parameters, energy convergence monitoring across iterations, and results comparison across simulated and real quantum hardware backends"
category: "developer-tools"
difficulty: "advanced"
timeToSetup: "15 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/pennylane"
tags: ["scientific", "claude-code", "pennylane", "machine-learning", "chemistry", "protein", "genomics", "quantum-computing"]
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/pennylane/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/pennylane
claude
```
