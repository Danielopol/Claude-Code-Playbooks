---
title: "Scientific Perplexity Search"
description: "Perform AI-powered web searches with real-time information using Perplexity models via LiteLLM and OpenRouter. This skill should be used when conducting web searches for current information, finding recent scientific literature, getting grounded a..."
seoHook: "Standard web search returns ten blue links, but you need synthesized, cited answers from current sources — especially for fast-moving scientific fields. Perplexity search via LiteLLM and OpenRouter delivers AI-synthesized answers with real-time web data and source citations, integrated directly into your workflow."
targetAudience: "researchers needing current information on rapidly evolving scientific topics, developers integrating real-time web search into automated research pipelines, analysts gathering grounded answers with citations for reports and briefings, science writers fact-checking claims against current web sources, technical teams building knowledge retrieval tools with AI-powered search"
exampleUseCase: "\"Search for the latest developments in protein language models published this year\" → Perplexity search: AI-synthesized summary of recent developments with inline citations, key papers and preprints identified with publication dates, comparison of approaches and their performance metrics, links to primary sources for deeper reading, and a structured research summary ready for inclusion in reports"
category: "developer-tools"
difficulty: "beginner"
timeToSetup: "5 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/perplexity-search"
tags: ["scientific", "claude-code", "perplexity-search", "bioinformatics", "chemistry", "statistics", "visualization", "database"]
...
```bash
mkdir -p ~/Projects/perplexity-search
```
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/perplexity-search/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/perplexity-search
claude
```
