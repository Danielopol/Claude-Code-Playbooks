---
title: "Scientific Phylogenetics"
description: "Build and analyze phylogenetic trees using MAFFT (multiple alignment), IQ-TREE 2 (maximum likelihood), and FastTree (fast NJ/ML). Visualize with ETE3 or FigTree. For evolutionary analysis, microbial genomics, viral phylodynamics, protein family an..."
seoHook: "You have 500 sequences and need a publication-quality phylogenetic tree — but the pipeline from alignment through model selection to tree visualization involves multiple tools with incompatible formats. This workflow chains MAFFT alignment, IQ-TREE 2 maximum likelihood inference, and ETE3 visualization into a seamless phylogenetics pipeline."
targetAudience: "evolutionary biologists constructing phylogenetic trees for taxonomic and comparative studies, microbiologists analyzing pathogen evolution and transmission patterns, virologists building phylodynamic trees for outbreak investigation, protein scientists studying protein family evolution and functional divergence, ecology researchers analyzing species relationships and biogeographic patterns"
exampleUseCase: "\"Build a maximum likelihood phylogeny from our viral sequences and identify clades\" → Phylogenetics pipeline: MAFFT multiple sequence alignment with appropriate algorithm selection, IQ-TREE 2 model testing and maximum likelihood tree inference with bootstrap support, clade identification and ancestral state reconstruction, publication-quality tree visualization with ETE3, and Newick/Nexus tree export for downstream analysis"
category: "academic-research"
difficulty: "intermediate"
timeToSetup: "10 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/phylogenetics"
tags: ["scientific", "claude-code", "phylogenetics", "bioinformatics", "visualization", "protein", "genomics"]
...
```bash
mkdir -p ~/Projects/phylogenetics
```
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/phylogenetics/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/phylogenetics
claude
```
