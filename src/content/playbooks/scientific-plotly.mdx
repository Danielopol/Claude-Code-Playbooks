...
seoHook: "Static charts can't show the detail your audience needs — they want to hover over data points, zoom into regions, and filter by category. Plotly creates interactive visualizations with hover info, zoom, pan, and click events that you can embed in dashboards, notebooks, or web pages."
...
exampleUseCase: "\"Create an interactive dashboard showing our experimental results with filtering by condition\" → Plotly dashboard: interactive scatter and line plots with hover details showing individual data points, dropdown filters for experimental conditions, zoom and pan for detailed data exploration, linked subplots that update together, and HTML export embeddable in any web page or notebook"
category: "data-reporting"
difficulty: "beginner"
timeToSetup: "5 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/plotly"
tags: ["scientific", "claude-code", "plotly", "statistics", "visualization", "database", "finance"]
