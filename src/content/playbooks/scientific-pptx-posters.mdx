...
seoHook: "Your collaborator wants the conference poster in PowerPoint format but LaTeX posters don't export to PPTX. HTML/CSS poster generation creates modern, web-styled research posters that export to both PDF and PowerPoint — giving you design flexibility without vendor lock-in."
targetAudience: "researchers needing conference posters in PowerPoint format for institutional templates, graduate students creating visually modern posters without LaTeX expertise, academic groups requiring poster templates that export to multiple formats, science communicators designing eye-catching research posters with web technologies, conference organizers providing poster templates compatible with common presentation software"
exampleUseCase: "\"Create a research poster in PPTX format for our department's template requirements\" → PPTX poster: HTML/CSS layout with modern responsive design, multi-column content organization with figure placement, institutional branding and color scheme application, dual export to PDF for printing and PPTX for editing, and a poster template customizable for future projects"
category: "creative-design"
difficulty: "intermediate"
timeToSetup: "10 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/pptx-posters"
tags: ["scientific", "claude-code", "pptx-posters", "chemistry", "visualization", "database", "protein", "genomics"]
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/pptx-posters/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/pptx-posters
claude
```
...
- **Read the docs**: Check the official pptx-posters documentation for latest API changes
