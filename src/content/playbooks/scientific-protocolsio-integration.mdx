---
title: "Scientific Protocolsio Integration"
description: "Integration with protocols.io API for managing scientific protocols. This skill should be used when working with protocols.io to search, create, update, or publish protocols; manage protocol steps and materials; handle discussions and comments; or..."
seoHook: "Your lab protocols live in Word documents that get emailed around and silently diverge between team members. Protocols.io API integration lets you programmatically create, version, search, and share protocols — ensuring everyone runs the same validated procedure with full revision history."
targetAudience: "lab managers standardizing protocols across research groups with version control, research compliance officers ensuring protocol reproducibility and audit trails, core facility managers publishing and maintaining shared standard operating procedures, graduate students documenting and sharing methods for their publications, automation engineers integrating protocol management with lab execution systems"
exampleUseCase: "\"Migrate our lab's Word document protocols to protocols.io with proper versioning\" → Protocols.io integration: API-based protocol creation with step-by-step structure, materials and reagent list management, version control for protocol updates, team sharing and commenting configuration, and DOI assignment for published protocols linked to your publications"
category: "academic-research"
difficulty: "intermediate"
timeToSetup: "10 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/protocolsio-integration"
tags: ["scientific", "claude-code", "protocolsio-integration", "database", "protein", "genomics", "writing"]
...
```bash
mkdir -p ~/Projects/protocolsio-integration
```
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/protocolsio-integration/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/protocolsio-integration
claude
```
