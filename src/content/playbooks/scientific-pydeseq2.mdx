...
seoHook: "Your RNA-seq experiment has count data and you need to identify differentially expressed genes — but the original DESeq2 requires R and Bioconductor. PyDESeq2 brings the same robust statistical framework (Wald tests, shrinkage estimators, FDR correction) to pure Python, integrating seamlessly with your pandas and scanpy workflows."
targetAudience: "bioinformaticians performing differential expression analysis in Python-only environments, RNA-seq researchers who prefer Python over R for their analysis pipelines, computational biologists integrating DE analysis with Python ML and visualization tools, genomics core facilities standardizing RNA-seq analysis in Python workflows, graduate students learning differential expression analysis with familiar Python syntax"
exampleUseCase: "\"Run differential expression analysis on our RNA-seq count matrix comparing treatment vs control\" → PyDESeq2 pipeline: count matrix loading and sample metadata setup, DESeq2 normalization and dispersion estimation, Wald test for differential expression with log2 fold change shrinkage, FDR correction and significance filtering, and volcano and MA plot visualization of results"
category: "academic-research"
difficulty: "intermediate"
timeToSetup: "10 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/pydeseq2"
tags: ["scientific", "claude-code", "pydeseq2", "bioinformatics", "statistics", "visualization", "database", "protein"]
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/pydeseq2/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/pydeseq2
claude
```
...
- **Read the docs**: Check the official pydeseq2 documentation for latest API changes
