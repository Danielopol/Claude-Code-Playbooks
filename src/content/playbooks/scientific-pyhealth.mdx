...
seoHook: "Building clinical prediction models from EHR data requires handling irregular time series, diagnosis codes, lab values, and medication records — each with different preprocessing needs. PyHealth provides end-to-end healthcare ML pipelines from raw EHR data to evaluated models for mortality, readmission, and diagnosis prediction."
targetAudience: "clinical informatics researchers building prediction models from electronic health record data, healthcare AI developers creating mortality and readmission risk classifiers, medical data scientists working with MIMIC-III/IV and eICU datasets, clinical decision support engineers deploying ML models in hospital settings, biomedical AI researchers benchmarking healthcare prediction algorithms"
exampleUseCase: "\"Build a 30-day readmission prediction model from our EHR data\" → PyHealth pipeline: EHR data loading with diagnosis, procedure, and medication code processing, temporal feature extraction from irregular clinical time series, model training with healthcare-specific architectures (RETAIN, SafeDrug), evaluation with clinical metrics (AUROC, AUPRC, calibration), and model export ready for clinical decision support integration"
category: "academic-research"
difficulty: "intermediate"
timeToSetup: "10 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/pyhealth"
tags: ["scientific", "claude-code", "pyhealth", "machine-learning", "chemistry", "statistics", "visualization", "protein"]
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/pyhealth/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/pyhealth
claude
```
