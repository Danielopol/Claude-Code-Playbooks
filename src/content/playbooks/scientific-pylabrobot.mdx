...
seoHook: "Your lab has a Hamilton liquid handler, a Tecan plate reader, and an Opentrons — each with its own proprietary software and scripting language. PyLabRobot provides a single Python API that controls all of them, letting you write vendor-agnostic automation protocols that work across any equipment combination."
targetAudience: "lab automation engineers integrating instruments from multiple vendors into unified workflows, core facility managers standardizing automation protocols across diverse equipment, synthetic biology teams building high-throughput screening workflows with mixed hardware, pharmaceutical scientists automating complex multi-instrument assay protocols, academic labs transitioning from manual to automated workflows without vendor lock-in"
exampleUseCase: "\"Automate our compound screening workflow across Hamilton, Tecan reader, and incubator\" → PyLabRobot protocol: unified Python control of Hamilton liquid handler for plate preparation, Tecan plate reader integration for absorbance measurements, incubator scheduling for growth periods, multi-instrument workflow orchestration with error handling, and a complete screening protocol executable across your entire equipment suite"
category: "academic-research"
difficulty: "intermediate"
timeToSetup: "10 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/pylabrobot"
tags: ["scientific", "claude-code", "pylabrobot", "visualization", "database", "writing"]
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/pylabrobot/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/pylabrobot
claude
```
