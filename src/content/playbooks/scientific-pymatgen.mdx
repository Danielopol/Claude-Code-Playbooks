...
seoHook: "Your computational materials project needs crystal structure manipulation, phase diagram calculation, and band structure analysis — but each requires different file formats and tools. Pymatgen handles CIF, POSCAR, and Materials Project data in a single Python framework for end-to-end computational materials science."
targetAudience: "computational materials scientists analyzing crystal structures and electronic properties, solid-state physicists computing phase diagrams and thermodynamic stability, battery researchers studying electrode materials and ion migration pathways, materials engineers screening candidates using Materials Project data, graduate students learning computational materials science with Python tools"
exampleUseCase: "\"Analyze the electronic structure and phase stability of our candidate battery cathode materials\" → Pymatgen workflow: crystal structure loading from CIF and Materials Project, band structure and density of states computation, phase diagram construction for thermodynamic stability assessment, ion migration pathway analysis for battery performance, and a materials screening report comparing candidates across computed properties"
category: "developer-tools"
difficulty: "intermediate"
timeToSetup: "10 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/pymatgen"
tags: ["scientific", "claude-code", "pymatgen", "bioinformatics", "chemistry", "visualization", "database", "protein"]
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/pymatgen/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/pymatgen
claude
```
