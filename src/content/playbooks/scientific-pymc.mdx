---
title: "Scientific Pymc"
description: "Bayesian modeling with PyMC. Build hierarchical models, MCMC (NUTS), variational inference, LOO/WAIC comparison, posterior checks, for probabilistic programming and inference."
seoHook: "Frequentist statistics can't handle your hierarchical data structure or incorporate prior knowledge from previous experiments. PyMC lets you build custom Bayesian models with MCMC sampling, variational inference, and model comparison — giving you full posterior distributions instead of just point estimates and p-values."
targetAudience: "statisticians building hierarchical and multilevel Bayesian models for complex data structures, epidemiologists fitting Bayesian disease transmission and survival models, social scientists using Bayesian methods for causal inference and measurement models, ecologists modeling species abundance with informative priors from expert knowledge, data scientists who need uncertainty quantification beyond confidence intervals"
exampleUseCase: "\"Build a hierarchical Bayesian model for our multi-site clinical trial data\" → PyMC workflow: hierarchical model specification with site-level and patient-level effects, prior elicitation based on previous studies, NUTS MCMC sampling with convergence diagnostics, posterior predictive checks for model validation, and LOO/WAIC model comparison against alternative specifications"
category: "data-reporting"
difficulty: "advanced"
timeToSetup: "15 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/pymc"
tags: ["scientific", "claude-code", "pymc", "statistics", "visualization", "database", "protein", "genomics"]
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/pymc/
```
