...
seoHook: "Your engineering design has conflicting objectives — minimize cost while maximizing performance and reliability — and there's no single optimal solution. pymoo finds the Pareto front of trade-off solutions using NSGA-II, NSGA-III, and MOEA/D, letting you see all optimal compromises before making a decision."
targetAudience: "engineers solving multi-objective design optimization problems with competing constraints, operations researchers finding Pareto-optimal solutions for logistics and scheduling, drug designers optimizing molecular properties across multiple conflicting targets, materials scientists balancing mechanical properties in alloy design, process engineers optimizing manufacturing parameters with multiple quality metrics"
exampleUseCase: "\"Optimize our reactor design for minimum cost, maximum yield, and minimum environmental impact\" → pymoo optimization: problem formulation with objective functions and constraints, NSGA-II evolutionary algorithm execution with population sizing, Pareto front visualization showing trade-off solutions, sensitivity analysis of design variables, and a decision matrix with ranked solutions for engineering review"
category: "data-reporting"
difficulty: "intermediate"
timeToSetup: "10 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/pymoo"
tags: ["scientific", "claude-code", "pymoo", "visualization", "database", "genomics"]
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/pymoo/
```
...
- **Read the docs**: Check the official pymoo documentation for latest API changes
