...
seoHook: "Building ML models for drug discovery requires curated datasets for ADMET properties, drug-target interactions, and toxicity — but collecting and cleaning this data takes months. Therapeutics Data Commons provides AI-ready benchmarks with proper scaffold splits and molecular oracles, letting you start training models immediately."
targetAudience: "drug discovery ML researchers benchmarking molecular property prediction models, computational chemists training ADMET prediction models on curated datasets, pharmaceutical AI teams evaluating drug-target interaction models, cheminformatics engineers building molecular optimization pipelines with oracle scoring, AI researchers comparing molecular generation methods on standardized benchmarks"
exampleUseCase: "\"Benchmark our molecular property predictor against TDC ADMET datasets\" → TDC workflow: dataset loading with standardized scaffold splits for fair evaluation, molecular featurization for model input, model training and cross-validation on ADMET benchmarks, comparison against published leaderboard results, and a benchmark report with performance metrics across all ADMET tasks"
category: "academic-research"
difficulty: "intermediate"
timeToSetup: "10 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/pytdc"
tags: ["scientific", "claude-code", "pytdc", "machine-learning", "chemistry", "statistics", "visualization", "database"]
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/pytdc/
```
...
- **Read the docs**: Check the official pytdc documentation for latest API changes
