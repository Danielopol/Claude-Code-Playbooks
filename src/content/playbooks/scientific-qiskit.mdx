...
seoHook: "You want to run quantum algorithms on real IBM quantum hardware but circuit compilation, error mitigation, and Qiskit Runtime primitives have a steep learning curve. Qiskit is IBM's quantum computing framework with built-in error mitigation, hardware-optimized transpilation, and production-ready Runtime services for real device execution."
targetAudience: "quantum computing researchers running algorithms on IBM quantum processors, quantum chemistry scientists performing molecular simulations with VQE on real hardware, quantum information students learning circuit programming with IBM's free quantum access, enterprise teams evaluating quantum computing for optimization problems, physics researchers studying quantum error mitigation and correction techniques"
exampleUseCase: "\"Run our quantum optimization algorithm on IBM hardware with error mitigation\" → Qiskit workflow: quantum circuit construction and optimization, transpilation for target IBM backend topology, Qiskit Runtime Sampler/Estimator primitive configuration, error mitigation with zero-noise extrapolation, and results analysis comparing simulator and hardware execution"
category: "developer-tools"
difficulty: "advanced"
timeToSetup: "15 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/qiskit"
tags: ["scientific", "claude-code", "qiskit", "machine-learning", "visualization", "database", "genomics", "quantum-computing"]
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/qiskit/
```
