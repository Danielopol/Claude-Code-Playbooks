...
seoHook: "Simulating open quantum systems — master equations, Lindblad dynamics, and decoherence — requires specialized solvers that standard numerical libraries don't provide. QuTiP is the standard Python framework for quantum optics and open quantum system simulation, used in thousands of physics papers."
targetAudience: "quantum optics researchers simulating cavity QED and light-matter interactions, condensed matter physicists modeling open quantum system dynamics and decoherence, quantum information scientists studying entanglement dynamics in noisy environments, physics graduate students learning quantum mechanics through computational simulation, AMO physics researchers modeling atom-photon interactions and quantum networks"
exampleUseCase: "\"Simulate the dynamics of our coupled qubit system with decoherence\" → QuTiP simulation: Hamiltonian construction for coupled qubit system, Lindblad master equation setup with decoherence channels, time evolution simulation with mesolve, expectation value and state fidelity tracking over time, and Bloch sphere visualization of qubit dynamics"
category: "developer-tools"
difficulty: "advanced"
timeToSetup: "15 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/qutip"
tags: ["scientific", "claude-code", "qutip", "visualization", "database", "genomics", "quantum-computing"]
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/qutip/
```
