...
seoHook: "Your cheminformatics project needs SMILES parsing, molecular descriptor calculation, substructure searching, and 3D conformer generation — all requiring fine-grained control over molecular representations. RDKit is the industry-standard open-source toolkit that powers most computational chemistry workflows."
targetAudience: "computational chemists performing molecular analysis with descriptors, fingerprints, and similarity metrics, medicinal chemists running substructure searches and reaction enumeration on compound libraries, cheminformatics engineers building molecular processing pipelines for drug discovery, materials scientists computing molecular properties for polymer and small molecule design, chemistry students learning cheminformatics with the most widely-used open-source toolkit"
exampleUseCase: "\"Compute molecular descriptors and fingerprints for our compound library and cluster by similarity\" → RDKit workflow: SMILES and SDF file parsing with sanitization, descriptor calculation (MW, LogP, TPSA, rotatable bonds), fingerprint generation (Morgan, MACCS, topological), Tanimoto similarity matrix computation, and chemical space clustering with 2D visualization of compound diversity"
category: "academic-research"
difficulty: "intermediate"
timeToSetup: "10 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/rdkit"
tags: ["scientific", "claude-code", "rdkit", "chemistry", "visualization", "database", "protein", "genomics"]
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/rdkit/
```
