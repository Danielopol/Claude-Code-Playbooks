---
title: "Scientific Research Grants"
...
seoHook: "Grant writing takes months of effort and most proposals get rejected because they don't align with agency-specific review criteria and formatting requirements. Structured grant writing workflows guide you through NSF, NIH, DOE, and DARPA proposal formats — from specific aims through broader impacts — optimized for how reviewers actually score."
targetAudience: "early-career faculty writing their first major grant proposals for NSF or NIH, established PIs preparing multi-PI proposals with complex budget structures, research administrators helping investigators meet agency-specific submission requirements, postdocs developing K-award and fellowship applications, grant writing consultants supporting multiple investigators across funding agencies"
exampleUseCase: "\"Draft an NSF CAREER proposal for our machine learning in materials science research\" → Grant writing workflow: specific aims page with compelling hook and significance framing, research plan structured around NSF review criteria, broader impacts section with education and outreach plan, budget preparation with justification narrative, and compliance check against NSF formatting and page limit requirements"
category: "research-writing"
difficulty: "intermediate"
timeToSetup: "10 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/research-grants"
tags: ["scientific", "claude-code", "research-grants", "statistics", "visualization", "database", "protein", "genomics"]
...
```bash
mkdir -p ~/Projects/research-grants
```
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/research-grants/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/research-grants
claude
```
...
- **Read the docs**: Check the official research-grants documentation for latest API changes
