---
title: "Scientific Scientific Slides"
...
seoHook: "Your conference talk is next week but you're still staring at blank slides, struggling to turn a 12-page paper into a compelling 15-minute presentation. Scientific slide workflows generate structured research presentations with proper visual hierarchy, speaker notes, and figure placement — ready for conference delivery."
targetAudience: "researchers preparing conference presentations and invited seminar talks, PhD students building thesis defense slide decks, postdocs creating job talk presentations from their research portfolio, lab group members preparing weekly lab meeting presentations, scientists converting manuscripts into visual presentation format for non-specialist audiences"
exampleUseCase: "\"Create a 20-minute conference presentation from our published paper on protein engineering\" → Slide deck: structured narrative arc from motivation through methods to results, key figure selection and reformatting for slides, speaker notes with timing estimates per slide, design template with consistent scientific styling, and PPTX output ready for conference presentation"
category: "creative-design"
difficulty: "intermediate"
timeToSetup: "10 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/scientific-slides"
tags: ["scientific", "claude-code", "scientific-slides", "bioinformatics", "machine-learning", "chemistry", "visualization", "database"]
...
```bash
mkdir -p ~/Projects/scientific-slides
```
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/scientific-slides/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/scientific-slides
claude
```
...
- **Read the docs**: Check the official scientific-slides documentation for latest API changes
