---
title: "Scientific Scientific Visualization"
description: "Meta-skill for publication-ready figures. Use when creating journal submission figures requiring multi-panel layouts, significance annotations, error bars, colorblind-safe palettes, and specific journal formatting (Nature, Science, Cell). Orchestr..."
seoHook: "Journal figure requirements are exacting — specific DPI, colorblind-safe palettes, multi-panel layouts with significance annotations, and formatting that varies between Nature, Science, and Cell. This meta-skill orchestrates matplotlib, seaborn, and plotly to produce figures that meet any journal's submission guidelines."
targetAudience: "researchers preparing publication figures meeting specific journal formatting standards, scientists creating multi-panel figures with statistical annotations and error bars, data visualization specialists producing colorblind-accessible scientific graphics, graduate students learning best practices for scientific figure design, lab groups standardizing figure styles across all their publications"
exampleUseCase: "\"Create a multi-panel figure with our Western blot, bar chart with significance, and survival curve for Nature submission\" → Publication figure: multi-panel layout with labeled panels (a, b, c), significance annotations and error bars on quantitative plots, colorblind-safe palette selection, Nature-specific formatting (font sizes, resolution, dimensions), and export at 300+ DPI in TIFF and PDF"
category: "data-reporting"
difficulty: "intermediate"
timeToSetup: "10 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/scientific-visualization"
tags: ["scientific", "claude-code", "scientific-visualization", "bioinformatics", "statistics", "visualization", "database", "genomics"]
...
```bash
mkdir -p ~/Projects/scientific-visualization
```
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/scientific-visualization/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/scientific-visualization
claude
```
