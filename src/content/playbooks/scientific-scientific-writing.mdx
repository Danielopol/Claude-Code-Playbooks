---
title: "Scientific Scientific Writing"
...
seoHook: "Writing a manuscript's introduction requires weaving together dozens of references into flowing prose — not bullet points. The two-stage scientific writing workflow first outlines key points with research-backed citations, then converts them into polished IMRAD-formatted paragraphs ready for journal submission."
targetAudience: "researchers drafting manuscripts for peer-reviewed journal submission, graduate students writing thesis chapters and dissertation sections, postdocs preparing research articles from their experimental results, science writers converting research findings into accessible narrative prose, collaborative teams needing consistent writing quality across multi-author manuscripts"
exampleUseCase: "\"Draft the introduction and discussion sections for our protein engineering manuscript\" → Scientific writing: section outline with key arguments and supporting citations, research-backed evidence gathering for each claim, flowing prose conversion in IMRAD format, proper citation integration following journal style, and polished manuscript sections ready for co-author review"
category: "research-writing"
difficulty: "intermediate"
timeToSetup: "10 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/scientific-writing"
tags: ["scientific", "claude-code", "scientific-writing", "machine-learning", "chemistry", "statistics", "visualization", "database"]
...
```bash
mkdir -p ~/Projects/scientific-writing
```
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/scientific-writing/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/scientific-writing
claude
```
...
- **Read the docs**: Check the official scientific-writing documentation for latest API changes
