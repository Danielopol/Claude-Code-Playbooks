...
seoHook: "Your 16S microbiome study needs alpha diversity, beta diversity with UniFrac distances, PERMANOVA testing, and ordination plots — analyses that require specialized ecological statistics libraries. scikit-bio provides sequence analysis, diversity metrics, and statistical ecology tools designed specifically for microbiome and biological data."
targetAudience: "microbiome researchers computing diversity metrics and comparing community composition, ecologists performing ordination and multivariate statistical analysis on species data, bioinformaticians building sequence analysis pipelines with alignment and phylogenetic tools, environmental scientists analyzing microbial community structure across samples, metagenomics researchers computing beta diversity and running PERMANOVA tests"
exampleUseCase: "\"Compute alpha and beta diversity from our 16S amplicon data and test for group differences\" → scikit-bio workflow: sequence loading and alignment from FASTA files, alpha diversity computation (Shannon, Simpson, observed OTUs), beta diversity with UniFrac and Bray-Curtis distances, PCoA ordination and visualization, and PERMANOVA statistical testing for group differences"
category: "academic-research"
difficulty: "intermediate"
timeToSetup: "10 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/scikit-bio"
tags: ["scientific", "claude-code", "scikit-bio", "bioinformatics", "machine-learning", "statistics", "visualization", "database"]
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/scikit-bio/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/scikit-bio
claude
```
