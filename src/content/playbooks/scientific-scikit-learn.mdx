...
seoHook: "You need a classification model but the pipeline from feature preprocessing through model selection, hyperparameter tuning, and cross-validation is complex and easy to get wrong. Scikit-learn provides the complete ML toolkit with consistent APIs — making it possible to try 10 algorithms with proper evaluation in an afternoon."
targetAudience: "data scientists building classification and regression models with proper cross-validation, researchers applying ML to scientific datasets for prediction and pattern discovery, analysts performing dimensionality reduction and clustering for exploratory analysis, engineers building ML pipelines with preprocessing, feature selection, and model evaluation, students learning machine learning fundamentals with the most widely-taught Python framework"
exampleUseCase: "\"Build a classifier for our patient data with feature selection, hyperparameter tuning, and proper evaluation\" → Scikit-learn pipeline: data preprocessing with scaling and encoding, feature selection with mutual information and recursive elimination, model comparison across Random Forest, SVM, and XGBoost, GridSearchCV hyperparameter optimization, and evaluation report with ROC curves, confusion matrix, and cross-validated metrics"
category: "data-reporting"
difficulty: "intermediate"
timeToSetup: "10 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/scikit-learn"
tags: ["scientific", "claude-code", "scikit-learn", "machine-learning", "statistics", "visualization", "database", "protein"]
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/scikit-learn/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/scikit-learn
claude
```
