---
title: "Scientific Scikit Survival"
description: "Comprehensive toolkit for survival analysis and time-to-event modeling in Python using scikit-survival. Use this skill when working with censored survival data, performing time-to-event analysis, fitting Cox models, Random Survival Forests, Gradie..."
seoHook: "Your clinical data has censored survival times and you need Cox models, random survival forests, and concordance indices — but lifelines doesn't support ML-based survival methods. Scikit-survival combines classical survival analysis with machine learning, providing Cox models alongside gradient boosted survival analysis with scikit-learn's familiar API."
targetAudience: "clinical researchers performing survival analysis on censored patient outcome data, biostatisticians fitting Cox proportional hazards models and checking assumptions, ML engineers building predictive survival models with random survival forests, oncology researchers analyzing treatment effects on overall and progression-free survival, epidemiologists modeling time-to-event data for disease incidence studies"
exampleUseCase: "\"Build a survival prediction model for our clinical trial data comparing Cox and ML approaches\" → Scikit-survival pipeline: Kaplan-Meier estimation and log-rank testing, Cox proportional hazards model with assumption checking, Random Survival Forest and Gradient Boosted Survival training, concordance index and time-dependent AUC evaluation, and Kaplan-Meier plots with risk group stratification"
category: "academic-research"
difficulty: "intermediate"
timeToSetup: "10 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/scikit-survival"
tags: ["scientific", "claude-code", "scikit-survival", "statistics", "database", "genomics"]
...
```bash
mkdir -p ~/Projects/scikit-survival
```
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/scikit-survival/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/scikit-survival
claude
```
