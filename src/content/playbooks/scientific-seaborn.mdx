...
seoHook: "You need box plots, violin plots, and correlation heatmaps but matplotlib requires 50 lines of formatting code for each one. Seaborn produces publication-quality statistical plots from pandas DataFrames in a single function call — with attractive defaults that actually look good without manual tweaking."
targetAudience: "data scientists exploring distributions and relationships in tabular data, researchers creating statistical comparison plots for manuscripts, analysts building quick visual summaries of experimental results, bioinformaticians visualizing gene expression and sample comparisons, students learning data visualization with intuitive high-level plotting"
exampleUseCase: "\"Visualize our experimental results with box plots by group and a correlation heatmap\" → Seaborn plots: grouped box and violin plots comparing conditions with statistical annotations, pair plots showing variable relationships colored by group, correlation heatmap with hierarchical clustering, categorical comparison plots with individual data points, and all figures exported at publication resolution"
category: "data-reporting"
difficulty: "beginner"
timeToSetup: "5 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/seaborn"
tags: ["scientific", "claude-code", "seaborn", "statistics", "visualization", "database", "protein", "genomics"]
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/seaborn/
```
