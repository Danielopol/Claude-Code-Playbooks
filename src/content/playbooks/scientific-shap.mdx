---
title: "Scientific Shap"
description: "Model interpretability and explainability using SHAP (SHapley Additive exPlanations). Use this skill when explaining machine learning model predictions, computing feature importance, generating SHAP plots (waterfall, beeswarm, bar, scatter, force,..."
seoHook: "Your ML model achieves 95% accuracy but stakeholders won't adopt it because they can't understand why it makes specific predictions. SHAP provides mathematically grounded feature importance that explains both global model behavior and individual predictions — the gold standard for ML interpretability."
targetAudience: "data scientists explaining model predictions to business stakeholders and regulators, ML engineers building interpretable AI systems for healthcare and finance, researchers understanding which features drive their model's predictions, compliance teams ensuring ML models meet explainability requirements, scientists using feature importance to generate biological or scientific hypotheses from model behavior"
exampleUseCase: "\"Explain our patient risk model's predictions to the clinical team with feature importance\" → SHAP analysis: global feature importance with beeswarm and bar plots, individual prediction explanations with waterfall and force plots, feature interaction detection with dependence plots, cohort-level explanation comparing high-risk vs low-risk patients, and an interpretability report translating model behavior into clinical insights"
category: "data-reporting"
difficulty: "intermediate"
timeToSetup: "10 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/shap"
tags: ["scientific", "claude-code", "shap", "machine-learning", "statistics", "visualization", "database", "genomics"]
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/shap/
```
