---
title: "Scientific Simpy"
description: "Process-based discrete-event simulation framework in Python. Use this skill when building simulations of systems with processes, queues, resources, and time-based events such as manufacturing systems, service operations, network traffic, logistics..."
seoHook: "You need to test whether adding a second server will reduce wait times, but experimenting on the real system is expensive and risky. SimPy lets you build discrete-event simulations of queues, factories, networks, and logistics in Python — testing 'what if' scenarios computationally before committing resources."
targetAudience: "operations researchers modeling manufacturing systems and service queues, logistics engineers simulating supply chain and warehouse operations, healthcare analysts optimizing patient flow and resource allocation in hospitals, network engineers modeling packet routing and server capacity, industrial engineers designing production lines with capacity planning"
exampleUseCase: "\"Simulate our hospital emergency department to optimize staffing and reduce wait times\" → SimPy simulation: patient arrival process modeling with empirical distributions, resource allocation for doctors, nurses, and beds, queue dynamics and wait time tracking, scenario comparison across staffing configurations, and a report with average wait times, utilization rates, and optimal staffing recommendations"
category: "data-reporting"
difficulty: "intermediate"
timeToSetup: "10 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/simpy"
tags: ["scientific", "claude-code", "simpy", "statistics", "protein", "genomics"]
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/simpy/
```
