---
title: "Scientific Statistical Analysis"
description: "Guided statistical analysis with test selection and reporting. Use when you need help choosing appropriate tests for your data, assumption checking, power analysis, and APA-formatted results. Best for academic research reporting, test selection gu..."
seoHook: "You have data from your experiment but aren't sure whether to use a t-test, ANOVA, or non-parametric alternative — and picking the wrong test invalidates your results. Guided statistical analysis helps you choose the right test, check assumptions, compute power, and report results in proper APA format."
targetAudience: "researchers needing guidance on appropriate statistical tests for their experimental designs, graduate students learning statistical analysis for their thesis data, clinical researchers reporting trial results with proper statistical formatting, social scientists choosing between parametric and non-parametric methods, lab scientists who need rigorous statistics but aren't trained statisticians"
exampleUseCase: "\"Analyze our experimental data with the right statistical tests and generate APA-formatted results\" → Statistical analysis: data exploration and normality/homogeneity assumption checking, appropriate test selection based on data structure and research question, power analysis for sample size justification, test execution with effect sizes and confidence intervals, and APA-formatted results tables ready for manuscript insertion"
category: "data-reporting"
difficulty: "intermediate"
timeToSetup: "10 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/statistical-analysis"
tags: ["scientific", "claude-code", "statistical-analysis", "statistics", "visualization", "database", "genomics"]
...
```bash
mkdir -p ~/Projects/statistical-analysis
```
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/statistical-analysis/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/statistical-analysis
claude
```
