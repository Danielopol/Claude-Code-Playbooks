---
title: "Scientific Torch Geometric"
...
seoHook: "Your data has relational structure — molecular graphs, social networks, or knowledge graphs — that standard neural networks can't capture. PyTorch Geometric provides GCN, GAT, GraphSAGE, and more for node classification, link prediction, and graph-level property prediction on any graph-structured data."
targetAudience: "ML researchers building graph neural network models for molecular property prediction, social network scientists applying deep learning to community detection and link prediction, drug discovery scientists training GNNs for molecular activity classification, knowledge graph engineers building entity and relation embedding models, computational biologists applying geometric deep learning to protein and interaction graphs"
exampleUseCase: "\"Train a GNN to predict molecular properties from molecular graphs\" → PyG pipeline: molecular graph dataset construction from SMILES with atom and bond features, GCN/GAT/GraphSAGE model architecture design, training with proper graph batching and pooling, evaluation with scaffold splits for fair benchmarking, and attention visualization showing which substructures drive predictions"
category: "data-reporting"
difficulty: "advanced"
timeToSetup: "15 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/torch-geometric"
tags: ["scientific", "claude-code", "torch-geometric", "machine-learning", "chemistry", "visualization", "database", "protein"]
...
```bash
mkdir -p ~/Projects/torch-geometric
```
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/torch-geometric/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/torch-geometric
claude
```
...
- **Read the docs**: Check the official torch-geometric documentation for latest API changes
