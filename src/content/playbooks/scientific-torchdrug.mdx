---
title: "Scientific Torchdrug"
description: "PyTorch-native graph neural networks for molecules and proteins. Use when building custom GNN architectures for drug discovery, protein modeling, or knowledge graph reasoning. Best for custom model development, protein property prediction, retrosy..."
seoHook: "Building custom GNN models for drug discovery requires handling molecular graphs, protein structures, and knowledge graphs — each with different data loading and evaluation needs. TorchDrug provides PyTorch-native building blocks specifically designed for molecular property prediction, protein modeling, and retrosynthesis."
targetAudience: "drug discovery ML researchers developing custom graph neural network architectures for molecules, protein scientists training deep learning models for protein function and structure prediction, computational chemists building retrosynthesis prediction models, AI researchers benchmarking molecular and protein representation learning methods, cheminformatics engineers developing end-to-end drug discovery pipelines with GNNs"
exampleUseCase: "\"Build a custom GNN model for predicting protein-ligand binding affinity\" → TorchDrug pipeline: protein and molecule graph construction with biologically relevant features, custom GNN architecture design with message passing layers, training on binding affinity benchmark datasets, evaluation with proper molecular scaffold splits, and model analysis showing learned protein-ligand interaction patterns"
category: "academic-research"
difficulty: "advanced"
timeToSetup: "15 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/torchdrug"
tags: ["scientific", "claude-code", "torchdrug", "machine-learning", "chemistry", "visualization", "database", "protein"]
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/torchdrug/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/torchdrug
claude
```
...
- **Read the docs**: Check the official torchdrug documentation for latest API changes
