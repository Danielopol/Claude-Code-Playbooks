---
title: "Scientific Treatment Plans"
...
seoHook: "Writing individualized treatment plans from scratch for every patient takes hours of clinical documentation time. This workflow generates structured, concise medical treatment plans in LaTeX/PDF format across all clinical specialties — from rehabilitation to chronic disease management — in minutes."
targetAudience: "clinical physicians drafting individualized patient treatment protocols, rehabilitation therapists documenting therapy goals and progression plans, mental health professionals creating structured care plans for patients, chronic disease care coordinators developing long-term management strategies, medical residents learning to write comprehensive treatment documentation"
exampleUseCase: "\"Create a rehabilitation treatment plan for a post-stroke patient\" → Treatment plan pipeline: patient assessment summary with functional baselines, structured therapy goals (short-term and long-term), intervention schedule with specific modalities, progress milestones and reassessment criteria, and professional LaTeX/PDF output ready for the clinical record"
category: "academic-research"
difficulty: "intermediate"
timeToSetup: "10 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/treatment-plans"
tags: ["scientific", "claude-code", "treatment-plans", "chemistry", "visualization", "database", "protein", "genomics"]
...
```bash
mkdir -p ~/Projects/treatment-plans
```
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/treatment-plans/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/treatment-plans
claude
```
