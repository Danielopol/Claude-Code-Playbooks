...
seoHook: "Your high-dimensional dataset has hundreds of features but t-SNE takes hours and PCA loses nonlinear structure. UMAP provides fast, scalable manifold learning that preserves both local and global data topology — producing meaningful 2D/3D embeddings for visualization and downstream clustering."
targetAudience: "bioinformaticians visualizing single-cell RNA-seq data in reduced dimensions, machine learning engineers preprocessing high-dimensional features before clustering with HDBSCAN, computational biologists exploring protein sequence or gene expression spaces, data scientists building interactive exploration tools for complex datasets, NLP researchers visualizing document or word embeddings"
exampleUseCase: "\"Reduce our 50-feature customer dataset to 2D for cluster visualization\" → UMAP pipeline: data scaling and preprocessing, UMAP embedding with tuned n_neighbors and min_dist parameters, 2D scatter visualization colored by cluster labels from HDBSCAN, comparison with t-SNE and PCA embeddings, and interactive plot export for stakeholder exploration"
category: "data-reporting"
difficulty: "intermediate"
timeToSetup: "10 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/umap-learn"
tags: ["scientific", "claude-code", "umap-learn", "machine-learning", "visualization", "database", "protein", "genomics"]
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/umap-learn/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/umap-learn
claude
```
