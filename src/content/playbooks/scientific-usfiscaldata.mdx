...
seoHook: "Federal financial data is locked behind Treasury websites with no easy way to pull historical trends programmatically. The U.S. Treasury Fiscal Data API gives you free, keyless access to 54 datasets covering national debt, spending, revenue, exchange rates, and savings bonds — ready for analysis in Python."
targetAudience: "economists researching federal spending and revenue trends over time, public policy analysts studying national debt and deficit dynamics, financial journalists building data-driven stories on government finances, political scientists quantifying fiscal policy impacts across administrations, data journalists creating interactive visualizations of Treasury data"
exampleUseCase: "\"Track the growth of U.S. national debt over the past 20 years\" → Fiscal Data pipeline: API query for historical debt-to-the-penny dataset, time series construction with monthly granularity, inflation-adjusted and nominal trend visualization, comparison against GDP growth rates, and exportable charts showing debt trajectory and key policy milestones"
category: "finance"
difficulty: "beginner"
timeToSetup: "5 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/usfiscaldata"
tags: ["scientific", "claude-code", "usfiscaldata", "database", "protein", "finance"]
createdAt: "2026-03-06"
---

## What This Does

A scientific skill for usfiscaldata workflows with Claude Code.
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/usfiscaldata/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/usfiscaldata
claude
```
...
- **Read the docs**: Check the official usfiscaldata documentation for latest API changes
