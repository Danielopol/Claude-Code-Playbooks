---
title: "Scientific Uspto Database"
...
seoHook: "Searching patents manually on USPTO.gov is painfully slow when you need to analyze hundreds of filings for prior art or competitive intelligence. This workflow provides programmatic access to USPTO APIs for patent and trademark searches, examination histories, assignments, citations, and office actions."
targetAudience: "patent attorneys conducting prior art searches and freedom-to-operate analyses, IP strategists mapping competitive patent landscapes for technology domains, R&D managers monitoring competitor filing activity and patent portfolios, technology transfer officers evaluating university patent assets, startup founders assessing IP risks before product launches"
exampleUseCase: "\"Map the patent landscape for CRISPR gene editing technology\" → USPTO pipeline: full-text patent search with CPC classification filtering, citation network analysis showing key foundational patents, assignee breakdown identifying major players, filing trend visualization over time, and examination status tracking for pending applications"
category: "academic-research"
difficulty: "beginner"
timeToSetup: "5 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/uspto-database"
tags: ["scientific", "claude-code", "uspto-database", "machine-learning", "database", "writing"]
...
```bash
mkdir -p ~/Projects/uspto-database
```
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/uspto-database/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/uspto-database
claude
```
