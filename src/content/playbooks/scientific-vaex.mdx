...
seoHook: "Your dataset has billions of rows and pandas crashes with out-of-memory errors every time you try to load it. Vaex processes billion-row DataFrames without loading them into RAM — using memory-mapped files, lazy evaluation, and columnar computation to deliver fast aggregations and visualizations on commodity hardware."
targetAudience: "data engineers processing billion-row log files and event streams that exceed RAM, astronomers analyzing large survey catalogs like Gaia with billions of stellar observations, geospatial analysts working with massive GPS trace or sensor datasets, quantitative analysts exploring tick-level financial data spanning years, ML engineers performing feature engineering on datasets too large for pandas"
exampleUseCase: "\"Analyze our 2 billion row clickstream dataset on a 32GB machine\" → Vaex pipeline: memory-mapped HDF5 file loading with zero RAM overhead, lazy column expressions for feature engineering, fast grouped aggregations (mean, count, percentiles) by user segment, interactive histogram and heatmap visualization of behavioral patterns, and filtered export to Parquet for downstream modeling"
category: "data-reporting"
difficulty: "intermediate"
timeToSetup: "10 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/vaex"
tags: ["scientific", "claude-code", "vaex", "machine-learning", "statistics", "visualization", "protein", "finance"]
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/vaex/
```
