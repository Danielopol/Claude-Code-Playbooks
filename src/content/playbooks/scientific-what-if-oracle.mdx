---
title: "Scientific What If Oracle"
...
seoHook: "Strategic decisions require exploring multiple futures, but ad-hoc brainstorming misses critical second-order effects and interaction dynamics. This workflow runs structured What-If scenario analysis with systematic multi-branch possibility exploration, probability weighting, and consequence mapping."
targetAudience: "strategic planners evaluating business decisions with multiple uncertain outcomes, policy analysts modeling the downstream effects of regulatory changes, research scientists exploring experimental design alternatives before committing resources, product managers assessing feature roadmap trade-offs under different market conditions, risk managers mapping cascading failure scenarios across interconnected systems"
exampleUseCase: "\"What if we switch our database from PostgreSQL to a distributed system?\" → What-If analysis: scenario tree with migration paths (CockroachDB, Spanner, YugabyteDB), impact assessment across performance, cost, team skills, and operational complexity, risk identification for each branch, probability-weighted outcome scoring, and recommended decision with supporting rationale"
category: "research-writing"
difficulty: "advanced"
timeToSetup: "15 minutes"
author: "K-Dense AI"
sourceUrl: "https://github.com/K-Dense-AI/claude-scientific-skills/tree/main/scientific-skills/what-if-oracle"
tags: ["scientific", "claude-code", "what-if-oracle", "bioinformatics", "database", "protein", "genomics", "finance"]
createdAt: "2026-03-06"
---

## What This Does

A scientific skill for what if oracle workflows with Claude Code.
...
```bash
mkdir -p ~/Projects/what-if-oracle
```
...
```bash
mv ~/Downloads/CLAUDE.md ~/Projects/what-if-oracle/
```

### Step 3: Start Claude Code

```bash
cd ~/Projects/what-if-oracle
claude
```
...
- **Read the docs**: Check the official what-if-oracle documentation for latest API changes
