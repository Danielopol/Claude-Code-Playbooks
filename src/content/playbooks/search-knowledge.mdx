...
description: "Search stored brand knowledge."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent search knowledge work — Search stored brand knowledge. Use when: recalling past learnings, voice guidelines, or competitor insights via semantic search. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /search-knowledge for our brand\" → Search Knowledge workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "productivity"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/search-knowledge/SKILL.md"
...
Create a dedicated folder for this workflow (e.g. `~/marketing/search-knowledge`).
