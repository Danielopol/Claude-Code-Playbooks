...
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent segment audience work — Create audience segments. Use when: building or updating CRM or email platform segments for campaign targeting. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /segment-audience for our brand\" → Segment Audience workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/segment-audience/SKILL.md"
tags: ["segment", "audience"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/segment-audience`).
