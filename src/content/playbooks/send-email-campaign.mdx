...
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent send email campaign work — Send email campaigns. Use when: deploying via SendGrid, Klaviyo, Customer.io, Brevo, or Mailgun with A/B testing. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "lifecycle marketers, email marketers, CRM managers"
exampleUseCase: "\"Run /send-email-campaign for our brand\" → Send Email Campaign workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/send-email-campaign/SKILL.md"
tags: ["send", "email", "campaign"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/send-email-campaign`).
