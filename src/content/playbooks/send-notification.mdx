...
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent send notification work — Send team notifications. Use when: pushing campaign updates, alerts, or approval requests via Slack or Intercom. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /send-notification for our brand\" → Send Notification workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/send-notification/SKILL.md"
...
Create a dedicated folder for this workflow (e.g. `~/marketing/send-notification`).
