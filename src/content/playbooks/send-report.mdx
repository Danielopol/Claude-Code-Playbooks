---
title: "Send Report"
description: "Deliver performance reports."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent send report work — Deliver performance reports. Use when: sending KPI summaries via Slack, email, or Google Sheets with analysis. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "marketing analysts, growth analysts, BI leads"
exampleUseCase: "\"Run /send-report for our brand\" → Send Report workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "data-reporting"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/send-report/SKILL.md"
tags: ["send", "report"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/send-report`).
