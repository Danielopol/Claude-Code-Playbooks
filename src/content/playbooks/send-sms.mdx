---
title: "Send Sms"
description: "Send SMS or WhatsApp messages."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent send sms work — Send SMS or WhatsApp messages. Use when: deploying marketing messages via Twilio or Brevo with compliance checks. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "lifecycle marketers, email marketers, CRM managers"
exampleUseCase: "\"Run /send-sms for our brand\" → Send Sms workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/send-sms/SKILL.md"
tags: ["send", "sms"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/send-sms`).
