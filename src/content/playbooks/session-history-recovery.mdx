---
title: "Recover Lost Code from Claude Code Sessions"
description: "Lost code when a Claude Code session ended? A recovery workflow that scans the session files in ~/.claude/, finds the code Claude wrote by date or keyword, and re-applies it to your project."
