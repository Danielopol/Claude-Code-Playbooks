...
description: "Measure share of voice."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent share of voice work — Measure share of voice. Use when: comparing keyword visibility, SERP presence, ad share, or AI citations vs competitors. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /share-of-voice for our brand\" → Share Of Voice workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/share-of-voice/SKILL.md"
tags: ["share", "voice"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/share-of-voice`).
