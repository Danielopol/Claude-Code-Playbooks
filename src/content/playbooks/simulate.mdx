---
title: "Simulate"
description: "Simulate revenue impact via Monte Carlo."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent simulate work — Simulate revenue impact via Monte Carlo. Use when: testing channel mix changes, budget shifts, or new channel launches. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /simulate for our brand\" → Simulate workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "data-reporting"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/simulate/SKILL.md"
tags: ["simulate"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/simulate`).
