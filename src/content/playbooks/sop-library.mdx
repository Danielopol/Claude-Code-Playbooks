---
title: "Sop Library"
description: "Manage agency SOPs."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent sop library work — Manage agency SOPs. Use when: creating, assigning, versioning, or auditing standard operating procedures. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /sop-library for our brand\" → Sop Library workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "productivity"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/sop-library/SKILL.md"
tags: ["sop", "library"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/sop-library`).
