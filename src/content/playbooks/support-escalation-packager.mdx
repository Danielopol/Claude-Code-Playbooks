...
seoHook: "Engineers hate getting vague escalations that say 'customer reports it's broken' with no reproduction steps or context. This playbook packages support issues into structured escalation briefs with full context, reproduction steps, impact assessment, and priority justification."
targetAudience: "support team leads standardizing how issues get escalated to engineering, customer success managers escalating high-impact account issues to management, technical support engineers packaging bug reports with proper reproduction details, support operations managers reducing engineering bounce-back rates on escalations, help desk supervisors training agents to write actionable escalation briefs"
exampleUseCase: "\"Package this customer's data export issue for engineering escalation\" → Escalation packager pipeline: customer context summary (account tier, revenue, tenure), issue timeline reconstruction from ticket history, technical details with reproduction steps and environment info, business impact assessment with affected customer count, and priority recommendation with SLA implications"
