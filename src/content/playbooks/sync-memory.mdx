---
title: "Sync Memory"
description: "Batch sync session learnings to memory."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent sync memory work — Batch sync session learnings to memory. Use when: persisting campaign insights and performance history across sessions. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /sync-memory for our brand\" → Sync Memory workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "productivity"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/sync-memory/SKILL.md"
tags: ["sync", "memory"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/sync-memory`).
