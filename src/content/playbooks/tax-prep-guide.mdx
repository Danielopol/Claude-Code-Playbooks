...
seoHook: "You know you need to file taxes but aren't sure which forms you need, what documents to gather, or which deductions apply to your situation. This playbook walks you through a guided Q&A to assess your tax situation and generate a personalized preparation plan with document checklists."
targetAudience: "first-time tax filers who need step-by-step guidance on what to prepare, freelancers and gig workers with complex tax situations across multiple income sources, small business owners unsure which business deductions they qualify for, individuals with life changes (marriage, home purchase, job change) affecting their tax filing, people switching from professional tax prep to self-filing who need a clear preparation roadmap"
exampleUseCase: "\"Help me prepare for filing my taxes as a freelancer with side income\" → Tax prep pipeline: guided Q&A assessing income sources, filing status, and deduction eligibility, personalized document checklist (1099-NEC, business expense receipts, home office measurements), applicable deduction identification with estimated savings, recommended filing workflow (self-file vs professional), and preparation timeline with deadlines"
category: "finance"
difficulty: "beginner"
