...
description: "Translate marketing content."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent translate content work — Translate marketing content. Use when: localizing with brand voice preservation, quality scoring, or transcreation. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "content marketers, content strategists, editors"
exampleUseCase: "\"Run /translate-content for our brand\" → Translate Content workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/translate-content/SKILL.md"
tags: ["translate", "content"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/translate-content`).
