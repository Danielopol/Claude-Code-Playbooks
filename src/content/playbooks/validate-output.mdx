...
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent validate output work — Validate content structure. Use when: checking schema compliance, required sections, word count, or placeholders. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /validate-output for our brand\" → Validate Output workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "productivity"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/validate-output/SKILL.md"
tags: ["validate", "output"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/validate-output`).
