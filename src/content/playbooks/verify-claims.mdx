---
title: "Verify Claims"
description: "Verify marketing claims."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent verify claims work — Verify marketing claims. Use when: cross-checking statistics, awards, certifications, or performance claims with sources. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /verify-claims for our brand\" → Verify Claims workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "productivity"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/verify-claims/SKILL.md"
tags: ["verify", "claims"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/verify-claims`).
