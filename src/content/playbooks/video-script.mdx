...
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent video script work — Write video scripts. Use when: creating YouTube, TikTok, Reels, LinkedIn, demo, or explainer video content. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "content marketers, content strategists, editors"
exampleUseCase: "\"Run /video-script for our brand\" → Video Script workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "marketing-content"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/video-script/SKILL.md"
tags: ["video", "script"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/video-script`).
