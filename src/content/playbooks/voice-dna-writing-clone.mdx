...
seoHook: "Everything Claude writes sounds like Claude — polished but generic, with the same cadence every AI user recognizes. This playbook analyzes your writing samples to extract your voice DNA and creates a single markdown file that makes Claude write in your actual style, tone, and rhythm."
targetAudience: "personal brand builders who need AI-generated content that sounds authentically like them, ghostwriters maintaining consistent client voice across large content volumes, newsletter authors scaling content production without losing their distinctive style, thought leaders delegating writing while preserving their unique perspective, content creators who want AI assistance without the 'AI voice' problem"
exampleUseCase: "\"Clone my writing voice so Claude matches my newsletter style\" → Voice DNA pipeline: writing sample analysis extracting sentence length patterns, vocabulary preferences, and rhetorical habits, tone profiling (formal vs casual, humor style, persuasion approach), voice DNA file generation with specific writing rules and examples, test generation comparing original vs cloned samples, and iterative refinement until output is indistinguishable from your natural voice"
