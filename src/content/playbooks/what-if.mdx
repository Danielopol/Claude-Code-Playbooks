---
title: "What If"
description: "Compare budget scenarios side-by-side."
seoHook: "Marketing teams lose hours to ad-hoc, inconsistent what if work — Compare budget scenarios side-by-side. Use when: testing 2-4 allocation variants with projected outcomes. This playbook turns the process into a repeatable, brand-aware workflow."
targetAudience: "digital marketers, marketing managers, growth marketers"
exampleUseCase: "\"Run /what-if for our brand\" → What If workflow output with brand context, structured inputs captured, process steps executed, and a complete deliverable ready for review."
category: "data-reporting"
difficulty: "intermediate"
timeToSetup: "15 minutes"
author: "community"
sourceUrl: "https://github.com/indranilbanerjee/digital-marketing-pro/blob/main/skills/what-if/SKILL.md"
tags: ["what"]
...
Create a dedicated folder for this workflow (e.g. `~/marketing/what-if`).
