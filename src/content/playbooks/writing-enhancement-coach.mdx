...
seoHook: "You've written a draft but it needs tightening and you can't afford an editor for every piece. This playbook provides iterative writing feedback on outlines, paragraph-level critique, structural guidance, and section-by-section coaching to strengthen your articles and essays through multiple revision rounds."
targetAudience: "graduate students improving thesis chapters and academic paper drafts, bloggers wanting editorial-quality feedback on their articles before publishing, non-native English writers seeking clear guidance on improving clarity and flow, professionals writing thought leadership articles who need structural feedback, aspiring authors working through manuscript drafts without access to a writing group"
exampleUseCase: "\"Coach me through improving my article draft on remote work culture\" → Writing coach pipeline: structural analysis of argument flow and logical progression, paragraph-level feedback on clarity, conciseness, and transitions, opening and closing strength assessment with rewrite suggestions, evidence and example gap identification, and iterative revision guidance through multiple improvement rounds"
