...
export const internalBlogPosts: BlogPost[] = [
  {
    ...
    description: 'Which Claude skill to use at each stage of a literature review — finding papers, screening and extracting, building a synthesis matrix, and drafting a thematic review — plus a step-by-step way to do a literature review with Claude without inventing citations.',
    category: 'guide',
    difficulty: 'basic',
    readingTime: '9 min read',
    featured: false,
    thumbnailType: 'skill',
    thumbnailTitle: 'Lit Review Skills',
  ...
  {
    id: 'claude-skills-academic-writing',
    slug: 'claude-skills-academic-writing',
    title: 'Claude Skills for Academic Writing: Thesis, Research Papers, and Peer Review',
    description: 'The Claude skills that help at the writing stage of research — structuring a thesis or paper, drafting with verified citations, self-review before submission, responding to reviewers, and grant proposals — and what each one is best at.',
    category: 'guide',
    difficulty: 'intermediate',
    readingTime: '9 min read',
    featured: false,
    thumbnailType: 'skill',
    thumbnailTitle: 'Academic Writing',
  ...
  {
    id: 'claude-skills-resume-cv',
    slug: 'claude-skills-resume-cv',
    title: 'Claude Skills for Resume & CV Writing (Plus Cover Letters and ATS Checks)',
    description: 'The Claude skills for each job-application document: tailoring a resume to a posting with an ATS keyword check, building a clean CV you can update in one place, writing cover letters that sound specific, and prepping interview answers from your real experience.',
    category: 'guide',
    difficulty: 'basic',
    readingTime: '8 min read',
    featured: false,
    thumbnailType: 'skill',
    thumbnailTitle: 'Resume & CV',
  ...
  {
    id: 'claude-dataviz-skills',
    slug: 'claude-dataviz-skills',
    title: 'Claude Dataviz Skills: The Best Skills for Charts and Data Visualization',
    description: 'Which Claude data visualization skill to use for each job — picking the right chart, publication-quality figures in matplotlib or plotly, dashboards from a CSV, self-contained HTML dashboards, and infographic layouts.',
    category: 'guide',
    difficulty: 'basic',
    readingTime: '7 min read',
    featured: false,
    thumbnailType: 'skill',
    thumbnailTitle: 'Dataviz Skills',
    tags: ['claude dataviz skill', 'claude data visualization skill', 'claude chart skill', 'data visualization', 'dashboards', 'Claude Code'],
    createdAt: '2026-09-26',
    author: 'Claude Code Playbooks',
  },
  {
    id: 'what-is-an-ic-memo',
    slug: 'what-is-an-ic-memo',
    title: 'What Is an IC Memo? Template, Example, and a Claude Skill to Draft One',
    description: 'An IC memo (investment committee memo) is the document a deal team writes to get approval for an investment. Here is what goes in one, a section-by-section template, a short illustrative example, and how to draft one with Claude.',
    category: 'guide',
    difficulty: 'intermediate',
    readingTime: '8 min read',
    featured: false,
    thumbnailType: 'skill',
    thumbnailTitle: 'IC Memo Guide',
