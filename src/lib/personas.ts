...
export const personas: PersonaInfo[] = [
  ...
  // 156 playbook matches
  {
    ...
    title: 'Claude for Executives & Directors',
    description: 'Strategic analysis, competitive intelligence, board presentations, and decision support.',
    seoDescription: 'How to use Claude as an executive — Claude Code playbooks for executives and directors: an AI chief of staff, competitive intelligence, strategic foresight, communications, and decision support.',
    icon: 'Target',
  ...
  // 140 playbook matches
  {
    ...
    title: 'Claude for Teachers, Students & Educators',
    description: 'Study smarter with research assistance, note organization, and learning workflows.',
    seoDescription: 'How to use Claude for teaching and studying — Claude Code playbooks for teachers, students, and educators: lesson plans, courses and quizzes, study guides, research assistance, and note organization.',
    icon: 'GraduationCap',
  ...
  // 102 playbook matches
  {
    id: 'hr-managers',
    name: 'HR & People Ops',
    title: 'Claude for HR & People Ops',
    description: 'Streamline recruiting, onboarding, policy documentation, and internal communications.',
    seoDescription: 'How to use Claude for HR — Claude Code playbooks for HR professionals and people ops: resume screening, job descriptions, onboarding, policy docs, and team communications.',
    icon: 'Users',
  ...
  // 82 playbook matches
  {
    ...
    title: 'Claude for Consultants & Coaches',
    description: 'Deliver strategic insights, manage engagements, and create client deliverables faster.',
    seoDescription: 'How to use Claude for consulting — Claude Code playbooks for consultants and coaches: strategic analysis, market research, client deliverables, frameworks, and proposal writing.',
    icon: 'Lightbulb',
  ...
  // 79 playbook matches
  {
    ...
    title: 'Claude for Finance & Accounting',
    description: 'Automate bookkeeping, financial reporting, reconciliation, and compliance workflows.',
    seoDescription: 'How to use Claude for accounting and finance — Claude Code playbooks for accountants and finance teams: expense tracking, invoicing, reconciliation, financial analysis, reporting, and compliance.',
    icon: 'DollarSign',
  ...
  // 38 playbook matches
  {
    ...
    title: 'Claude for Project Managers',
    description: 'Plan sprints, track progress, coordinate teams, and generate status reports.',
    seoDescription: 'How to use Claude for project management — Claude Code playbooks for project managers: sprint planning, status reports, team coordination, agile workflows, and task management.',
    icon: 'LayoutGrid',
  ...
  // 19 playbook matches (equity-research + finance-accounting)
  {
    ...
    title: 'Claude for Equity Research',
    description: 'Draft morning notes, build earnings models, initiate coverage, and track investment theses.',
    seoDescription: 'How to use Claude for equity research — Claude Code playbooks for analysts: earnings analysis, sector overviews, coverage initiation, model updates, morning notes, and thesis tracking.',
    icon: 'TrendingUp',
  ...
  // 19 playbook matches (investment-banking + finance-accounting)
  {
    ...
    title: 'Claude for Investment Banking',
    description: 'Build pitch decks, CIMs, merger models, buyer lists, and manage deal execution workflows.',
    seoDescription: 'How to use Claude for investment banking — Claude Code playbooks for bankers: pitch decks, CIMs, merger models, LBO models, DCF valuation, buyer lists, and deal process management.',
    icon: 'Building',
  ...
  // 10 playbook matches
  {
    ...
    title: 'Claude for Private Equity',
    description: 'Screen deals, run due diligence, draft IC memos, and build value creation plans.',
    seoDescription: 'How to use Claude for private equity — Claude Code playbooks for PE professionals: deal sourcing, due diligence, IC memos, portfolio monitoring, returns analysis, and value creation planning.',
    icon: 'Landmark',
